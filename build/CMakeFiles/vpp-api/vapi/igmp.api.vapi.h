#ifndef __included_igmp_api_json
#define __included_igmp_api_json
...
static inline int vapi_verify_igmp_listen_reply_msg_size(vapi_msg_igmp_listen_reply *msg, uword buf_size)
{
  if (sizeof(vapi_msg_igmp_listen_reply) > buf_size)
    {
      VAPI_ERR("Truncated 'igmp_listen_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_igmp_listen_reply));
      return -1;
    }
  if (vapi_calc_igmp_listen_reply_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'igmp_listen_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_igmp_listen_reply_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_igmp_listen_reply()
{
  ...
  static vapi_message_desc_t __vapi_metadata_igmp_listen_reply = {
    ...
    (verify_msg_size_fn_t)vapi_verify_igmp_listen_reply_msg_size,
...
{
  return sizeof(*msg) + sizeof(msg->payload.group.saddrs[0]) * msg->payload.group.n_srcs;
}

static inline int vapi_verify_igmp_listen_msg_size(vapi_msg_igmp_listen *msg, uword buf_size)
{
  if (sizeof(vapi_msg_igmp_listen) > buf_size)
    {
      VAPI_ERR("Truncated 'igmp_listen' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_igmp_listen));
      return -1;
    }
  if (vapi_calc_igmp_listen_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'igmp_listen' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_igmp_listen_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send (ctx, msg))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_igmp_listen_reply, VAPI_REQUEST_REG, 
...
static void __attribute__((constructor)) __vapi_constructor_igmp_listen()
{
  ...
  static const char name_with_crc[] = "igmp_listen_19a49f1e";
  static vapi_message_desc_t __vapi_metadata_igmp_listen = {
    ...
    (verify_msg_size_fn_t)vapi_verify_igmp_listen_msg_size,
...
static inline int vapi_verify_igmp_enable_disable_reply_msg_size(vapi_msg_igmp_enable_disable_reply *msg, uword buf_size)
{
  if (sizeof(vapi_msg_igmp_enable_disable_reply) > buf_size)
    {
      VAPI_ERR("Truncated 'igmp_enable_disable_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_igmp_enable_disable_reply));
      return -1;
    }
  if (vapi_calc_igmp_enable_disable_reply_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'igmp_enable_disable_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_igmp_enable_disable_reply_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_igmp_enable_disable_reply()
{
  ...
  static vapi_message_desc_t __vapi_metadata_igmp_enable_disable_reply = {
    ...
    (verify_msg_size_fn_t)vapi_verify_igmp_enable_disable_reply_msg_size,
...
static inline int vapi_verify_igmp_enable_disable_msg_size(vapi_msg_igmp_enable_disable *msg, uword buf_size)
{
  if (sizeof(vapi_msg_igmp_enable_disable) > buf_size)
    {
      VAPI_ERR("Truncated 'igmp_enable_disable' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_igmp_enable_disable));
      return -1;
    }
  if (vapi_calc_igmp_enable_disable_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'igmp_enable_disable' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_igmp_enable_disable_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send (ctx, msg))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_igmp_enable_disable_reply, VAPI_REQUEST_REG, 
                       (vapi_cb_t)reply_callback, reply_callback_ctx);
    if (VAPI_OK != vapi_producer_unlock (ctx)) {
      abort (); /* this really shouldn't happen */
    }
...
static void __attribute__((constructor)) __vapi_constructor_igmp_enable_disable()
{
  ...
  static const char name_with_crc[] = "igmp_enable_disable_b1edfb96";
  static vapi_message_desc_t __vapi_metadata_igmp_enable_disable = {
    ...
    (verify_msg_size_fn_t)vapi_verify_igmp_enable_disable_msg_size,
...
static inline int vapi_verify_igmp_proxy_device_add_del_reply_msg_size(vapi_msg_igmp_proxy_device_add_del_reply *msg, uword buf_size)
{
  if (sizeof(vapi_msg_igmp_proxy_device_add_del_reply) > buf_size)
    {
      VAPI_ERR("Truncated 'igmp_proxy_device_add_del_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_igmp_proxy_device_add_del_reply));
      return -1;
    }
  if (vapi_calc_igmp_proxy_device_add_del_reply_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'igmp_proxy_device_add_del_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_igmp_proxy_device_add_del_reply_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_igmp_proxy_device_add_del_reply()
{
  ...
  static vapi_message_desc_t __vapi_metadata_igmp_proxy_device_add_del_reply = {
    ...
    (verify_msg_size_fn_t)vapi_verify_igmp_proxy_device_add_del_reply_msg_size,
...
static inline int vapi_verify_igmp_proxy_device_add_del_msg_size(vapi_msg_igmp_proxy_device_add_del *msg, uword buf_size)
{
  if (sizeof(vapi_msg_igmp_proxy_device_add_del) > buf_size)
    {
      VAPI_ERR("Truncated 'igmp_proxy_device_add_del' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_igmp_proxy_device_add_del));
      return -1;
    }
  if (vapi_calc_igmp_proxy_device_add_del_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'igmp_proxy_device_add_del' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_igmp_proxy_device_add_del_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send (ctx, msg))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_igmp_proxy_device_add_del_reply, VAPI_REQUEST_REG, 
                       (vapi_cb_t)reply_callback, reply_callback_ctx);
    if (VAPI_OK != vapi_producer_unlock (ctx)) {
      abort (); /* this really shouldn't happen */
    }
...
static void __attribute__((constructor)) __vapi_constructor_igmp_proxy_device_add_del()
{
  ...
  static const char name_with_crc[] = "igmp_proxy_device_add_del_0b9be9ce";
  static vapi_message_desc_t __vapi_metadata_igmp_proxy_device_add_del = {
    ...
    (verify_msg_size_fn_t)vapi_verify_igmp_proxy_device_add_del_msg_size,
...
static inline int vapi_verify_igmp_proxy_device_add_del_interface_reply_msg_size(vapi_msg_igmp_proxy_device_add_del_interface_reply *msg, uword buf_size)
{
  if (sizeof(vapi_msg_igmp_proxy_device_add_del_interface_reply) > buf_size)
    {
      VAPI_ERR("Truncated 'igmp_proxy_device_add_del_interface_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_igmp_proxy_device_add_del_interface_reply));
      return -1;
    }
  if (vapi_calc_igmp_proxy_device_add_del_interface_reply_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'igmp_proxy_device_add_del_interface_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_igmp_proxy_device_add_del_interface_reply_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_igmp_proxy_device_add_del_interface_reply()
{
  ...
  static vapi_message_desc_t __vapi_metadata_igmp_proxy_device_add_del_interface_reply = {
    ...
    (verify_msg_size_fn_t)vapi_verify_igmp_proxy_device_add_del_interface_reply_msg_size,
...
static inline int vapi_verify_igmp_proxy_device_add_del_interface_msg_size(vapi_msg_igmp_proxy_device_add_del_interface *msg, uword buf_size)
{
  if (sizeof(vapi_msg_igmp_proxy_device_add_del_interface) > buf_size)
    {
      VAPI_ERR("Truncated 'igmp_proxy_device_add_del_interface' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_igmp_proxy_device_add_del_interface));
      return -1;
    }
  if (vapi_calc_igmp_proxy_device_add_del_interface_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'igmp_proxy_device_add_del_interface' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_igmp_proxy_device_add_del_interface_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send (ctx, msg))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_igmp_proxy_device_add_del_interface_reply, VAPI_REQUEST_REG, 
                       (vapi_cb_t)reply_callback, reply_callback_ctx);
    if (VAPI_OK != vapi_producer_unlock (ctx)) {
      abort (); /* this really shouldn't happen */
    }
...
static void __attribute__((constructor)) __vapi_constructor_igmp_proxy_device_add_del_interface()
{
  ...
  static const char name_with_crc[] = "igmp_proxy_device_add_del_interface_1a9ec24a";
  static vapi_message_desc_t __vapi_metadata_igmp_proxy_device_add_del_interface = {
    ...
    (verify_msg_size_fn_t)vapi_verify_igmp_proxy_device_add_del_interface_msg_size,
...
static inline int vapi_verify_igmp_details_msg_size(vapi_msg_igmp_details *msg, uword buf_size)
{
  if (sizeof(vapi_msg_igmp_details) > buf_size)
    {
      VAPI_ERR("Truncated 'igmp_details' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_igmp_details));
      return -1;
    }
  if (vapi_calc_igmp_details_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'igmp_details' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_igmp_details_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_igmp_details()
{
  ...
  static const char name_with_crc[] = "igmp_details_38f09929";
  static vapi_message_desc_t __vapi_metadata_igmp_details = {
    ...
    (verify_msg_size_fn_t)vapi_verify_igmp_details_msg_size,
...
static inline int vapi_verify_igmp_dump_msg_size(vapi_msg_igmp_dump *msg, uword buf_size)
{
  if (sizeof(vapi_msg_igmp_dump) > buf_size)
    {
      VAPI_ERR("Truncated 'igmp_dump' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_igmp_dump));
      return -1;
    }
  if (vapi_calc_igmp_dump_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'igmp_dump' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_igmp_dump_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send_with_control_ping (ctx, msg, req_context))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_igmp_details, VAPI_REQUEST_DUMP, 
                       (vapi_cb_t)reply_callback, reply_callback_ctx);
    if (VAPI_OK != vapi_producer_unlock (ctx)) {
      abort (); /* this really shouldn't happen */
    }
...
static void __attribute__((constructor)) __vapi_constructor_igmp_dump()
{
  ...
  static const char name_with_crc[] = "igmp_dump_f9e6675e";
  static vapi_message_desc_t __vapi_metadata_igmp_dump = {
    ...
    (verify_msg_size_fn_t)vapi_verify_igmp_dump_msg_size,
...
static inline int vapi_verify_igmp_clear_interface_reply_msg_size(vapi_msg_igmp_clear_interface_reply *msg, uword buf_size)
{
  if (sizeof(vapi_msg_igmp_clear_interface_reply) > buf_size)
    {
      VAPI_ERR("Truncated 'igmp_clear_interface_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_igmp_clear_interface_reply));
      return -1;
    }
  if (vapi_calc_igmp_clear_interface_reply_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'igmp_clear_interface_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_igmp_clear_interface_reply_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_igmp_clear_interface_reply()
{
  ...
  static vapi_message_desc_t __vapi_metadata_igmp_clear_interface_reply = {
    ...
    (verify_msg_size_fn_t)vapi_verify_igmp_clear_interface_reply_msg_size,
...
static inline int vapi_verify_igmp_clear_interface_msg_size(vapi_msg_igmp_clear_interface *msg, uword buf_size)
{
  if (sizeof(vapi_msg_igmp_clear_interface) > buf_size)
    {
      VAPI_ERR("Truncated 'igmp_clear_interface' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_igmp_clear_interface));
      return -1;
    }
  if (vapi_calc_igmp_clear_interface_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'igmp_clear_interface' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_igmp_clear_interface_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send (ctx, msg))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_igmp_clear_interface_reply, VAPI_REQUEST_REG, 
                       (vapi_cb_t)reply_callback, reply_callback_ctx);
    if (VAPI_OK != vapi_producer_unlock (ctx)) {
      abort (); /* this really shouldn't happen */
    }
...
static void __attribute__((constructor)) __vapi_constructor_igmp_clear_interface()
{
  ...
  static const char name_with_crc[] = "igmp_clear_interface_f9e6675e";
  static vapi_message_desc_t __vapi_metadata_igmp_clear_interface = {
    ...
    (verify_msg_size_fn_t)vapi_verify_igmp_clear_interface_msg_size,
...
static inline int vapi_verify_want_igmp_events_reply_msg_size(vapi_msg_want_igmp_events_reply *msg, uword buf_size)
{
  if (sizeof(vapi_msg_want_igmp_events_reply) > buf_size)
    {
      VAPI_ERR("Truncated 'want_igmp_events_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_want_igmp_events_reply));
      return -1;
    }
  if (vapi_calc_want_igmp_events_reply_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'want_igmp_events_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_want_igmp_events_reply_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_want_igmp_events_reply()
{
  ...
  static vapi_message_desc_t __vapi_metadata_want_igmp_events_reply = {
    ...
    (verify_msg_size_fn_t)vapi_verify_want_igmp_events_reply_msg_size,
...
static inline int vapi_verify_want_igmp_events_msg_size(vapi_msg_want_igmp_events *msg, uword buf_size)
{
  if (sizeof(vapi_msg_want_igmp_events) > buf_size)
    {
      VAPI_ERR("Truncated 'want_igmp_events' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_want_igmp_events));
      return -1;
    }
  if (vapi_calc_want_igmp_events_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'want_igmp_events' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_want_igmp_events_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send (ctx, msg))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_want_igmp_events_reply, VAPI_REQUEST_REG, 
                       (vapi_cb_t)reply_callback, reply_callback_ctx);
    if (VAPI_OK != vapi_producer_unlock (ctx)) {
      abort (); /* this really shouldn't happen */
    }
...
static void __attribute__((constructor)) __vapi_constructor_want_igmp_events()
{
  ...
  static vapi_message_desc_t __vapi_metadata_want_igmp_events = {
    ...
    (verify_msg_size_fn_t)vapi_verify_want_igmp_events_msg_size,
...
static inline int vapi_verify_igmp_event_msg_size(vapi_msg_igmp_event *msg, uword buf_size)
{
  if (sizeof(vapi_msg_igmp_event) > buf_size)
    {
      VAPI_ERR("Truncated 'igmp_event' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_igmp_event));
      return -1;
    }
  if (vapi_calc_igmp_event_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'igmp_event' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_igmp_event_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_igmp_event()
{
  ...
  static const char name_with_crc[] = "igmp_event_85fe93ec";
  static vapi_message_desc_t __vapi_metadata_igmp_event = {
    ...
    (verify_msg_size_fn_t)vapi_verify_igmp_event_msg_size,
...
static inline int vapi_verify_igmp_group_prefix_set_reply_msg_size(vapi_msg_igmp_group_prefix_set_reply *msg, uword buf_size)
{
  if (sizeof(vapi_msg_igmp_group_prefix_set_reply) > buf_size)
    {
      VAPI_ERR("Truncated 'igmp_group_prefix_set_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_igmp_group_prefix_set_reply));
      return -1;
    }
  if (vapi_calc_igmp_group_prefix_set_reply_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'igmp_group_prefix_set_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_igmp_group_prefix_set_reply_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_igmp_group_prefix_set_reply()
{
  ...
  static vapi_message_desc_t __vapi_metadata_igmp_group_prefix_set_reply = {
    ...
    (verify_msg_size_fn_t)vapi_verify_igmp_group_prefix_set_reply_msg_size,
...
static inline int vapi_verify_igmp_group_prefix_set_msg_size(vapi_msg_igmp_group_prefix_set *msg, uword buf_size)
{
  if (sizeof(vapi_msg_igmp_group_prefix_set) > buf_size)
    {
      VAPI_ERR("Truncated 'igmp_group_prefix_set' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_igmp_group_prefix_set));
      return -1;
    }
  if (vapi_calc_igmp_group_prefix_set_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'igmp_group_prefix_set' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_igmp_group_prefix_set_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send (ctx, msg))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_igmp_group_prefix_set_reply, VAPI_REQUEST_REG, 
                       (vapi_cb_t)reply_callback, reply_callback_ctx);
    if (VAPI_OK != vapi_producer_unlock (ctx)) {
      abort (); /* this really shouldn't happen */
    }
...
static void __attribute__((constructor)) __vapi_constructor_igmp_group_prefix_set()
{
  ...
  static const char name_with_crc[] = "igmp_group_prefix_set_5b14a5ce";
  static vapi_message_desc_t __vapi_metadata_igmp_group_prefix_set = {
    ...
    (verify_msg_size_fn_t)vapi_verify_igmp_group_prefix_set_msg_size,
...
static inline int vapi_verify_igmp_group_prefix_details_msg_size(vapi_msg_igmp_group_prefix_details *msg, uword buf_size)
{
  if (sizeof(vapi_msg_igmp_group_prefix_details) > buf_size)
    {
      VAPI_ERR("Truncated 'igmp_group_prefix_details' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_igmp_group_prefix_details));
      return -1;
    }
  if (vapi_calc_igmp_group_prefix_details_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'igmp_group_prefix_details' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_igmp_group_prefix_details_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_igmp_group_prefix_details()
{
  ...
  static const char name_with_crc[] = "igmp_group_prefix_details_259ccd81";
  static vapi_message_desc_t __vapi_metadata_igmp_group_prefix_details = {
    ...
    (verify_msg_size_fn_t)vapi_verify_igmp_group_prefix_details_msg_size,
...
static inline int vapi_verify_igmp_group_prefix_dump_msg_size(vapi_msg_igmp_group_prefix_dump *msg, uword buf_size)
{
  if (sizeof(vapi_msg_igmp_group_prefix_dump) > buf_size)
    {
      VAPI_ERR("Truncated 'igmp_group_prefix_dump' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_igmp_group_prefix_dump));
      return -1;
    }
  if (vapi_calc_igmp_group_prefix_dump_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'igmp_group_prefix_dump' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_igmp_group_prefix_dump_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send_with_control_ping (ctx, msg, req_context))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_igmp_group_prefix_details, VAPI_REQUEST_DUMP, 
                       (vapi_cb_t)reply_callback, reply_callback_ctx);
    if (VAPI_OK != vapi_producer_unlock (ctx)) {
      abort (); /* this really shouldn't happen */
    }
...
static void __attribute__((constructor)) __vapi_constructor_igmp_group_prefix_dump()
{
  ...
  static vapi_message_desc_t __vapi_metadata_igmp_group_prefix_dump = {
    ...
    offsetof(vapi_type_msg_header2_t, context),
    VAPI_INVALID_MSG_ID,
    (verify_msg_size_fn_t)vapi_verify_igmp_group_prefix_dump_msg_size,
