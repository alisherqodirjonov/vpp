#ifndef __included_ipip_api_json
#define __included_ipip_api_json
...
static inline int vapi_verify_ipip_add_tunnel_reply_msg_size(vapi_msg_ipip_add_tunnel_reply *msg, uword buf_size)
{
  if (sizeof(vapi_msg_ipip_add_tunnel_reply) > buf_size)
    {
      VAPI_ERR("Truncated 'ipip_add_tunnel_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_ipip_add_tunnel_reply));
      return -1;
    }
  if (vapi_calc_ipip_add_tunnel_reply_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'ipip_add_tunnel_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_ipip_add_tunnel_reply_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_ipip_add_tunnel_reply()
{
  ...
  static vapi_message_desc_t __vapi_metadata_ipip_add_tunnel_reply = {
    ...
    (verify_msg_size_fn_t)vapi_verify_ipip_add_tunnel_reply_msg_size,
...
static inline int vapi_verify_ipip_add_tunnel_msg_size(vapi_msg_ipip_add_tunnel *msg, uword buf_size)
{
  if (sizeof(vapi_msg_ipip_add_tunnel) > buf_size)
    {
      VAPI_ERR("Truncated 'ipip_add_tunnel' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_ipip_add_tunnel));
      return -1;
    }
  if (vapi_calc_ipip_add_tunnel_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'ipip_add_tunnel' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_ipip_add_tunnel_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send (ctx, msg))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_ipip_add_tunnel_reply, VAPI_REQUEST_REG, 
...
static void __attribute__((constructor)) __vapi_constructor_ipip_add_tunnel()
{
  ...
  static const char name_with_crc[] = "ipip_add_tunnel_2ac399f5";
  static vapi_message_desc_t __vapi_metadata_ipip_add_tunnel = {
    ...
    (verify_msg_size_fn_t)vapi_verify_ipip_add_tunnel_msg_size,
...
static inline int vapi_verify_ipip_del_tunnel_reply_msg_size(vapi_msg_ipip_del_tunnel_reply *msg, uword buf_size)
{
  if (sizeof(vapi_msg_ipip_del_tunnel_reply) > buf_size)
    {
      VAPI_ERR("Truncated 'ipip_del_tunnel_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_ipip_del_tunnel_reply));
      return -1;
    }
  if (vapi_calc_ipip_del_tunnel_reply_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'ipip_del_tunnel_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_ipip_del_tunnel_reply_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_ipip_del_tunnel_reply()
{
  ...
  static vapi_message_desc_t __vapi_metadata_ipip_del_tunnel_reply = {
    ...
    (verify_msg_size_fn_t)vapi_verify_ipip_del_tunnel_reply_msg_size,
...
static inline int vapi_verify_ipip_del_tunnel_msg_size(vapi_msg_ipip_del_tunnel *msg, uword buf_size)
{
  if (sizeof(vapi_msg_ipip_del_tunnel) > buf_size)
    {
      VAPI_ERR("Truncated 'ipip_del_tunnel' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_ipip_del_tunnel));
      return -1;
    }
  if (vapi_calc_ipip_del_tunnel_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'ipip_del_tunnel' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_ipip_del_tunnel_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send (ctx, msg))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_ipip_del_tunnel_reply, VAPI_REQUEST_REG, 
                       (vapi_cb_t)reply_callback, reply_callback_ctx);
    if (VAPI_OK != vapi_producer_unlock (ctx)) {
      abort (); /* this really shouldn't happen */
    }
...
static void __attribute__((constructor)) __vapi_constructor_ipip_del_tunnel()
{
  ...
  static vapi_message_desc_t __vapi_metadata_ipip_del_tunnel = {
    ...
    (verify_msg_size_fn_t)vapi_verify_ipip_del_tunnel_msg_size,
...
static inline int vapi_verify_ipip_6rd_add_tunnel_reply_msg_size(vapi_msg_ipip_6rd_add_tunnel_reply *msg, uword buf_size)
{
  if (sizeof(vapi_msg_ipip_6rd_add_tunnel_reply) > buf_size)
    {
      VAPI_ERR("Truncated 'ipip_6rd_add_tunnel_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_ipip_6rd_add_tunnel_reply));
      return -1;
    }
  if (vapi_calc_ipip_6rd_add_tunnel_reply_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'ipip_6rd_add_tunnel_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_ipip_6rd_add_tunnel_reply_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_ipip_6rd_add_tunnel_reply()
{
  ...
  static vapi_message_desc_t __vapi_metadata_ipip_6rd_add_tunnel_reply = {
    ...
    (verify_msg_size_fn_t)vapi_verify_ipip_6rd_add_tunnel_reply_msg_size,
...
static inline int vapi_verify_ipip_6rd_add_tunnel_msg_size(vapi_msg_ipip_6rd_add_tunnel *msg, uword buf_size)
{
  if (sizeof(vapi_msg_ipip_6rd_add_tunnel) > buf_size)
    {
      VAPI_ERR("Truncated 'ipip_6rd_add_tunnel' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_ipip_6rd_add_tunnel));
      return -1;
    }
  if (vapi_calc_ipip_6rd_add_tunnel_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'ipip_6rd_add_tunnel' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_ipip_6rd_add_tunnel_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send (ctx, msg))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_ipip_6rd_add_tunnel_reply, VAPI_REQUEST_REG, 
                       (vapi_cb_t)reply_callback, reply_callback_ctx);
    if (VAPI_OK != vapi_producer_unlock (ctx)) {
      abort (); /* this really shouldn't happen */
    }
...
static void __attribute__((constructor)) __vapi_constructor_ipip_6rd_add_tunnel()
{
  ...
  static const char name_with_crc[] = "ipip_6rd_add_tunnel_b9ec1863";
  static vapi_message_desc_t __vapi_metadata_ipip_6rd_add_tunnel = {
    ...
    (verify_msg_size_fn_t)vapi_verify_ipip_6rd_add_tunnel_msg_size,
...
static inline int vapi_verify_ipip_6rd_del_tunnel_reply_msg_size(vapi_msg_ipip_6rd_del_tunnel_reply *msg, uword buf_size)
{
  if (sizeof(vapi_msg_ipip_6rd_del_tunnel_reply) > buf_size)
    {
      VAPI_ERR("Truncated 'ipip_6rd_del_tunnel_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_ipip_6rd_del_tunnel_reply));
      return -1;
    }
  if (vapi_calc_ipip_6rd_del_tunnel_reply_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'ipip_6rd_del_tunnel_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_ipip_6rd_del_tunnel_reply_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_ipip_6rd_del_tunnel_reply()
{
  ...
  static vapi_message_desc_t __vapi_metadata_ipip_6rd_del_tunnel_reply = {
    ...
    (verify_msg_size_fn_t)vapi_verify_ipip_6rd_del_tunnel_reply_msg_size,
...
static inline int vapi_verify_ipip_6rd_del_tunnel_msg_size(vapi_msg_ipip_6rd_del_tunnel *msg, uword buf_size)
{
  if (sizeof(vapi_msg_ipip_6rd_del_tunnel) > buf_size)
    {
      VAPI_ERR("Truncated 'ipip_6rd_del_tunnel' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_ipip_6rd_del_tunnel));
      return -1;
    }
  if (vapi_calc_ipip_6rd_del_tunnel_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'ipip_6rd_del_tunnel' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_ipip_6rd_del_tunnel_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send (ctx, msg))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_ipip_6rd_del_tunnel_reply, VAPI_REQUEST_REG, 
                       (vapi_cb_t)reply_callback, reply_callback_ctx);
    if (VAPI_OK != vapi_producer_unlock (ctx)) {
      abort (); /* this really shouldn't happen */
    }
...
static void __attribute__((constructor)) __vapi_constructor_ipip_6rd_del_tunnel()
{
  ...
  static vapi_message_desc_t __vapi_metadata_ipip_6rd_del_tunnel = {
    ...
    (verify_msg_size_fn_t)vapi_verify_ipip_6rd_del_tunnel_msg_size,
...
static inline int vapi_verify_ipip_tunnel_details_msg_size(vapi_msg_ipip_tunnel_details *msg, uword buf_size)
{
  if (sizeof(vapi_msg_ipip_tunnel_details) > buf_size)
    {
      VAPI_ERR("Truncated 'ipip_tunnel_details' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_ipip_tunnel_details));
      return -1;
    }
  if (vapi_calc_ipip_tunnel_details_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'ipip_tunnel_details' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_ipip_tunnel_details_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_ipip_tunnel_details()
{
  ...
  static const char name_with_crc[] = "ipip_tunnel_details_d31cb34e";
  static vapi_message_desc_t __vapi_metadata_ipip_tunnel_details = {
    ...
    (verify_msg_size_fn_t)vapi_verify_ipip_tunnel_details_msg_size,
...
static inline int vapi_verify_ipip_tunnel_dump_msg_size(vapi_msg_ipip_tunnel_dump *msg, uword buf_size)
{
  if (sizeof(vapi_msg_ipip_tunnel_dump) > buf_size)
    {
      VAPI_ERR("Truncated 'ipip_tunnel_dump' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_ipip_tunnel_dump));
      return -1;
    }
  if (vapi_calc_ipip_tunnel_dump_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'ipip_tunnel_dump' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_ipip_tunnel_dump_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send_with_control_ping (ctx, msg, req_context))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_ipip_tunnel_details, VAPI_REQUEST_DUMP, 
                       (vapi_cb_t)reply_callback, reply_callback_ctx);
    if (VAPI_OK != vapi_producer_unlock (ctx)) {
      abort (); /* this really shouldn't happen */
    }
...
static void __attribute__((constructor)) __vapi_constructor_ipip_tunnel_dump()
{
  ...
  static vapi_message_desc_t __vapi_metadata_ipip_tunnel_dump = {
    ...
    (verify_msg_size_fn_t)vapi_verify_ipip_tunnel_dump_msg_size,
