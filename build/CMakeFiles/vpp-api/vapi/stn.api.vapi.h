#ifndef __included_stn_api_json
#define __included_stn_api_json
...
static inline int vapi_verify_stn_add_del_rule_reply_msg_size(vapi_msg_stn_add_del_rule_reply *msg, uword buf_size)
{
  if (sizeof(vapi_msg_stn_add_del_rule_reply) > buf_size)
    {
      VAPI_ERR("Truncated 'stn_add_del_rule_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_stn_add_del_rule_reply));
      return -1;
    }
  if (vapi_calc_stn_add_del_rule_reply_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'stn_add_del_rule_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_stn_add_del_rule_reply_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_stn_add_del_rule_reply()
{
  ...
  static vapi_message_desc_t __vapi_metadata_stn_add_del_rule_reply = {
    ...
    (verify_msg_size_fn_t)vapi_verify_stn_add_del_rule_reply_msg_size,
...
static inline int vapi_verify_stn_add_del_rule_msg_size(vapi_msg_stn_add_del_rule *msg, uword buf_size)
{
  if (sizeof(vapi_msg_stn_add_del_rule) > buf_size)
    {
      VAPI_ERR("Truncated 'stn_add_del_rule' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_stn_add_del_rule));
      return -1;
    }
  if (vapi_calc_stn_add_del_rule_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'stn_add_del_rule' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_stn_add_del_rule_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send (ctx, msg))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_stn_add_del_rule_reply, VAPI_REQUEST_REG, 
...
static void __attribute__((constructor)) __vapi_constructor_stn_add_del_rule()
{
  ...
  static const char name_with_crc[] = "stn_add_del_rule_224c6edd";
  static vapi_message_desc_t __vapi_metadata_stn_add_del_rule = {
    ...
    (verify_msg_size_fn_t)vapi_verify_stn_add_del_rule_msg_size,
...
static inline int vapi_verify_stn_rules_details_msg_size(vapi_msg_stn_rules_details *msg, uword buf_size)
{
  if (sizeof(vapi_msg_stn_rules_details) > buf_size)
    {
      VAPI_ERR("Truncated 'stn_rules_details' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_stn_rules_details));
      return -1;
    }
  if (vapi_calc_stn_rules_details_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'stn_rules_details' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_stn_rules_details_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_stn_rules_details()
{
  ...
  static const char name_with_crc[] = "stn_rules_details_a51935a6";
  static vapi_message_desc_t __vapi_metadata_stn_rules_details = {
    ...
    (verify_msg_size_fn_t)vapi_verify_stn_rules_details_msg_size,
...
static inline int vapi_verify_stn_rules_dump_msg_size(vapi_msg_stn_rules_dump *msg, uword buf_size)
{
  if (sizeof(vapi_msg_stn_rules_dump) > buf_size)
    {
      VAPI_ERR("Truncated 'stn_rules_dump' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_stn_rules_dump));
      return -1;
    }
  if (vapi_calc_stn_rules_dump_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'stn_rules_dump' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_stn_rules_dump_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send_with_control_ping (ctx, msg, req_context))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_stn_rules_details, VAPI_REQUEST_DUMP, 
                       (vapi_cb_t)reply_callback, reply_callback_ctx);
    if (VAPI_OK != vapi_producer_unlock (ctx)) {
      abort (); /* this really shouldn't happen */
    }
...
static void __attribute__((constructor)) __vapi_constructor_stn_rules_dump()
{
  ...
  static vapi_message_desc_t __vapi_metadata_stn_rules_dump = {
    ...
    offsetof(vapi_type_msg_header2_t, context),
    VAPI_INVALID_MSG_ID,
    (verify_msg_size_fn_t)vapi_verify_stn_rules_dump_msg_size,
