#ifndef __included_abf_api_json
#define __included_abf_api_json
...
static inline int vapi_verify_abf_plugin_get_version_reply_msg_size(vapi_msg_abf_plugin_get_version_reply *msg, uword buf_size)
{
  if (sizeof(vapi_msg_abf_plugin_get_version_reply) > buf_size)
    {
      VAPI_ERR("Truncated 'abf_plugin_get_version_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_abf_plugin_get_version_reply));
      return -1;
    }
  if (vapi_calc_abf_plugin_get_version_reply_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'abf_plugin_get_version_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_abf_plugin_get_version_reply_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_abf_plugin_get_version_reply()
{
  ...
  static vapi_message_desc_t __vapi_metadata_abf_plugin_get_version_reply = {
    ...
    (verify_msg_size_fn_t)vapi_verify_abf_plugin_get_version_reply_msg_size,
...
static inline int vapi_verify_abf_plugin_get_version_msg_size(vapi_msg_abf_plugin_get_version *msg, uword buf_size)
{
  if (sizeof(vapi_msg_abf_plugin_get_version) > buf_size)
    {
      VAPI_ERR("Truncated 'abf_plugin_get_version' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_abf_plugin_get_version));
      return -1;
    }
  if (vapi_calc_abf_plugin_get_version_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'abf_plugin_get_version' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_abf_plugin_get_version_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send (ctx, msg))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_abf_plugin_get_version_reply, VAPI_REQUEST_REG, 
...
static void __attribute__((constructor)) __vapi_constructor_abf_plugin_get_version()
{
  ...
  static vapi_message_desc_t __vapi_metadata_abf_plugin_get_version = {
    ...
    VAPI_INVALID_MSG_ID,
    (verify_msg_size_fn_t)vapi_verify_abf_plugin_get_version_msg_size,
...
static inline int vapi_verify_abf_policy_add_del_reply_msg_size(vapi_msg_abf_policy_add_del_reply *msg, uword buf_size)
{
  if (sizeof(vapi_msg_abf_policy_add_del_reply) > buf_size)
    {
      VAPI_ERR("Truncated 'abf_policy_add_del_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_abf_policy_add_del_reply));
      return -1;
    }
  if (vapi_calc_abf_policy_add_del_reply_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'abf_policy_add_del_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_abf_policy_add_del_reply_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_abf_policy_add_del_reply()
{
  ...
  static vapi_message_desc_t __vapi_metadata_abf_policy_add_del_reply = {
    ...
    (verify_msg_size_fn_t)vapi_verify_abf_policy_add_del_reply_msg_size,
...
{
  return sizeof(*msg) + sizeof(msg->payload.policy.paths[0]) * msg->payload.policy.n_paths;
}

static inline int vapi_verify_abf_policy_add_del_msg_size(vapi_msg_abf_policy_add_del *msg, uword buf_size)
{
  if (sizeof(vapi_msg_abf_policy_add_del) > buf_size)
    {
      VAPI_ERR("Truncated 'abf_policy_add_del' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_abf_policy_add_del));
      return -1;
    }
  if (vapi_calc_abf_policy_add_del_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'abf_policy_add_del' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_abf_policy_add_del_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send (ctx, msg))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_abf_policy_add_del_reply, VAPI_REQUEST_REG, 
                       (vapi_cb_t)reply_callback, reply_callback_ctx);
    if (VAPI_OK != vapi_producer_unlock (ctx)) {
      abort (); /* this really shouldn't happen */
    }
...
static void __attribute__((constructor)) __vapi_constructor_abf_policy_add_del()
{
  ...
  static const char name_with_crc[] = "abf_policy_add_del_c6131197";
  static vapi_message_desc_t __vapi_metadata_abf_policy_add_del = {
    ...
    (verify_msg_size_fn_t)vapi_verify_abf_policy_add_del_msg_size,
...
static inline int vapi_verify_abf_policy_details_msg_size(vapi_msg_abf_policy_details *msg, uword buf_size)
{
  if (sizeof(vapi_msg_abf_policy_details) > buf_size)
    {
      VAPI_ERR("Truncated 'abf_policy_details' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_abf_policy_details));
      return -1;
    }
  if (vapi_calc_abf_policy_details_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'abf_policy_details' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_abf_policy_details_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_abf_policy_details()
{
  ...
  static const char name_with_crc[] = "abf_policy_details_b7487fa4";
  static vapi_message_desc_t __vapi_metadata_abf_policy_details = {
    ...
    (verify_msg_size_fn_t)vapi_verify_abf_policy_details_msg_size,
...
static inline int vapi_verify_abf_policy_dump_msg_size(vapi_msg_abf_policy_dump *msg, uword buf_size)
{
  if (sizeof(vapi_msg_abf_policy_dump) > buf_size)
    {
      VAPI_ERR("Truncated 'abf_policy_dump' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_abf_policy_dump));
      return -1;
    }
  if (vapi_calc_abf_policy_dump_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'abf_policy_dump' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_abf_policy_dump_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send_with_control_ping (ctx, msg, req_context))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_abf_policy_details, VAPI_REQUEST_DUMP, 
                       (vapi_cb_t)reply_callback, reply_callback_ctx);
    if (VAPI_OK != vapi_producer_unlock (ctx)) {
      abort (); /* this really shouldn't happen */
    }
...
static void __attribute__((constructor)) __vapi_constructor_abf_policy_dump()
{
  ...
  static vapi_message_desc_t __vapi_metadata_abf_policy_dump = {
    ...
    offsetof(vapi_type_msg_header2_t, context),
    VAPI_INVALID_MSG_ID,
    (verify_msg_size_fn_t)vapi_verify_abf_policy_dump_msg_size,
...
static inline int vapi_verify_abf_itf_attach_add_del_reply_msg_size(vapi_msg_abf_itf_attach_add_del_reply *msg, uword buf_size)
{
  if (sizeof(vapi_msg_abf_itf_attach_add_del_reply) > buf_size)
    {
      VAPI_ERR("Truncated 'abf_itf_attach_add_del_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_abf_itf_attach_add_del_reply));
      return -1;
    }
  if (vapi_calc_abf_itf_attach_add_del_reply_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'abf_itf_attach_add_del_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_abf_itf_attach_add_del_reply_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_abf_itf_attach_add_del_reply()
{
  ...
  static vapi_message_desc_t __vapi_metadata_abf_itf_attach_add_del_reply = {
    ...
    (verify_msg_size_fn_t)vapi_verify_abf_itf_attach_add_del_reply_msg_size,
...
static inline int vapi_verify_abf_itf_attach_add_del_msg_size(vapi_msg_abf_itf_attach_add_del *msg, uword buf_size)
{
  if (sizeof(vapi_msg_abf_itf_attach_add_del) > buf_size)
    {
      VAPI_ERR("Truncated 'abf_itf_attach_add_del' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_abf_itf_attach_add_del));
      return -1;
    }
  if (vapi_calc_abf_itf_attach_add_del_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'abf_itf_attach_add_del' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_abf_itf_attach_add_del_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send (ctx, msg))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_abf_itf_attach_add_del_reply, VAPI_REQUEST_REG, 
                       (vapi_cb_t)reply_callback, reply_callback_ctx);
    if (VAPI_OK != vapi_producer_unlock (ctx)) {
      abort (); /* this really shouldn't happen */
    }
...
static void __attribute__((constructor)) __vapi_constructor_abf_itf_attach_add_del()
{
  ...
  static vapi_message_desc_t __vapi_metadata_abf_itf_attach_add_del = {
    ...
    (verify_msg_size_fn_t)vapi_verify_abf_itf_attach_add_del_msg_size,
...
static inline int vapi_verify_abf_itf_attach_details_msg_size(vapi_msg_abf_itf_attach_details *msg, uword buf_size)
{
  if (sizeof(vapi_msg_abf_itf_attach_details) > buf_size)
    {
      VAPI_ERR("Truncated 'abf_itf_attach_details' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_abf_itf_attach_details));
      return -1;
    }
  if (vapi_calc_abf_itf_attach_details_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'abf_itf_attach_details' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_abf_itf_attach_details_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_abf_itf_attach_details()
{
  ...
  static vapi_message_desc_t __vapi_metadata_abf_itf_attach_details = {
    ...
    (verify_msg_size_fn_t)vapi_verify_abf_itf_attach_details_msg_size,
...
static inline int vapi_verify_abf_itf_attach_dump_msg_size(vapi_msg_abf_itf_attach_dump *msg, uword buf_size)
{
  if (sizeof(vapi_msg_abf_itf_attach_dump) > buf_size)
    {
      VAPI_ERR("Truncated 'abf_itf_attach_dump' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_abf_itf_attach_dump));
      return -1;
    }
  if (vapi_calc_abf_itf_attach_dump_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'abf_itf_attach_dump' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_abf_itf_attach_dump_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send_with_control_ping (ctx, msg, req_context))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_abf_itf_attach_details, VAPI_REQUEST_DUMP, 
                       (vapi_cb_t)reply_callback, reply_callback_ctx);
    if (VAPI_OK != vapi_producer_unlock (ctx)) {
      abort (); /* this really shouldn't happen */
    }
...
static void __attribute__((constructor)) __vapi_constructor_abf_itf_attach_dump()
{
  ...
  static vapi_message_desc_t __vapi_metadata_abf_itf_attach_dump = {
    ...
    offsetof(vapi_type_msg_header2_t, context),
    VAPI_INVALID_MSG_ID,
    (verify_msg_size_fn_t)vapi_verify_abf_itf_attach_dump_msg_size,
