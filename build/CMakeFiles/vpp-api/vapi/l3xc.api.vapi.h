#ifndef __included_l3xc_api_json
#define __included_l3xc_api_json
...
static inline int vapi_verify_l3xc_plugin_get_version_reply_msg_size(vapi_msg_l3xc_plugin_get_version_reply *msg, uword buf_size)
{
  if (sizeof(vapi_msg_l3xc_plugin_get_version_reply) > buf_size)
    {
      VAPI_ERR("Truncated 'l3xc_plugin_get_version_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_l3xc_plugin_get_version_reply));
      return -1;
    }
  if (vapi_calc_l3xc_plugin_get_version_reply_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'l3xc_plugin_get_version_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_l3xc_plugin_get_version_reply_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_l3xc_plugin_get_version_reply()
{
  ...
  static vapi_message_desc_t __vapi_metadata_l3xc_plugin_get_version_reply = {
    ...
    (verify_msg_size_fn_t)vapi_verify_l3xc_plugin_get_version_reply_msg_size,
...
static inline int vapi_verify_l3xc_plugin_get_version_msg_size(vapi_msg_l3xc_plugin_get_version *msg, uword buf_size)
{
  if (sizeof(vapi_msg_l3xc_plugin_get_version) > buf_size)
    {
      VAPI_ERR("Truncated 'l3xc_plugin_get_version' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_l3xc_plugin_get_version));
      return -1;
    }
  if (vapi_calc_l3xc_plugin_get_version_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'l3xc_plugin_get_version' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_l3xc_plugin_get_version_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send (ctx, msg))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_l3xc_plugin_get_version_reply, VAPI_REQUEST_REG, 
...
static void __attribute__((constructor)) __vapi_constructor_l3xc_plugin_get_version()
{
  ...
  static vapi_message_desc_t __vapi_metadata_l3xc_plugin_get_version = {
    ...
    VAPI_INVALID_MSG_ID,
    (verify_msg_size_fn_t)vapi_verify_l3xc_plugin_get_version_msg_size,
...
static inline int vapi_verify_l3xc_update_reply_msg_size(vapi_msg_l3xc_update_reply *msg, uword buf_size)
{
  if (sizeof(vapi_msg_l3xc_update_reply) > buf_size)
    {
      VAPI_ERR("Truncated 'l3xc_update_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_l3xc_update_reply));
      return -1;
    }
  if (vapi_calc_l3xc_update_reply_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'l3xc_update_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_l3xc_update_reply_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_l3xc_update_reply()
{
  ...
  static vapi_message_desc_t __vapi_metadata_l3xc_update_reply = {
    ...
    (verify_msg_size_fn_t)vapi_verify_l3xc_update_reply_msg_size,
...
{
  return sizeof(*msg) + sizeof(msg->payload.l3xc.paths[0]) * msg->payload.l3xc.n_paths;
}

static inline int vapi_verify_l3xc_update_msg_size(vapi_msg_l3xc_update *msg, uword buf_size)
{
  if (sizeof(vapi_msg_l3xc_update) > buf_size)
    {
      VAPI_ERR("Truncated 'l3xc_update' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_l3xc_update));
      return -1;
    }
  if (vapi_calc_l3xc_update_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'l3xc_update' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_l3xc_update_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send (ctx, msg))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_l3xc_update_reply, VAPI_REQUEST_REG, 
                       (vapi_cb_t)reply_callback, reply_callback_ctx);
    if (VAPI_OK != vapi_producer_unlock (ctx)) {
      abort (); /* this really shouldn't happen */
    }
...
static void __attribute__((constructor)) __vapi_constructor_l3xc_update()
{
  ...
  static const char name_with_crc[] = "l3xc_update_e96aabdf";
  static vapi_message_desc_t __vapi_metadata_l3xc_update = {
    ...
    (verify_msg_size_fn_t)vapi_verify_l3xc_update_msg_size,
...
static inline int vapi_verify_l3xc_del_reply_msg_size(vapi_msg_l3xc_del_reply *msg, uword buf_size)
{
  if (sizeof(vapi_msg_l3xc_del_reply) > buf_size)
    {
      VAPI_ERR("Truncated 'l3xc_del_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_l3xc_del_reply));
      return -1;
    }
  if (vapi_calc_l3xc_del_reply_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'l3xc_del_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_l3xc_del_reply_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_l3xc_del_reply()
{
  ...
  static vapi_message_desc_t __vapi_metadata_l3xc_del_reply = {
    ...
    (verify_msg_size_fn_t)vapi_verify_l3xc_del_reply_msg_size,
...
static inline int vapi_verify_l3xc_del_msg_size(vapi_msg_l3xc_del *msg, uword buf_size)
{
  if (sizeof(vapi_msg_l3xc_del) > buf_size)
    {
      VAPI_ERR("Truncated 'l3xc_del' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_l3xc_del));
      return -1;
    }
  if (vapi_calc_l3xc_del_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'l3xc_del' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_l3xc_del_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send (ctx, msg))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_l3xc_del_reply, VAPI_REQUEST_REG, 
                       (vapi_cb_t)reply_callback, reply_callback_ctx);
    if (VAPI_OK != vapi_producer_unlock (ctx)) {
      abort (); /* this really shouldn't happen */
    }
...
static void __attribute__((constructor)) __vapi_constructor_l3xc_del()
{
  ...
  static vapi_message_desc_t __vapi_metadata_l3xc_del = {
    ...
    (verify_msg_size_fn_t)vapi_verify_l3xc_del_msg_size,
...
static inline int vapi_verify_l3xc_details_msg_size(vapi_msg_l3xc_details *msg, uword buf_size)
{
  if (sizeof(vapi_msg_l3xc_details) > buf_size)
    {
      VAPI_ERR("Truncated 'l3xc_details' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_l3xc_details));
      return -1;
    }
  if (vapi_calc_l3xc_details_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'l3xc_details' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_l3xc_details_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_l3xc_details()
{
  ...
  static const char name_with_crc[] = "l3xc_details_bc5bf852";
  static vapi_message_desc_t __vapi_metadata_l3xc_details = {
    ...
    (verify_msg_size_fn_t)vapi_verify_l3xc_details_msg_size,
...
static inline int vapi_verify_l3xc_dump_msg_size(vapi_msg_l3xc_dump *msg, uword buf_size)
{
  if (sizeof(vapi_msg_l3xc_dump) > buf_size)
    {
      VAPI_ERR("Truncated 'l3xc_dump' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_l3xc_dump));
      return -1;
    }
  if (vapi_calc_l3xc_dump_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'l3xc_dump' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_l3xc_dump_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send_with_control_ping (ctx, msg, req_context))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_l3xc_details, VAPI_REQUEST_DUMP, 
                       (vapi_cb_t)reply_callback, reply_callback_ctx);
    if (VAPI_OK != vapi_producer_unlock (ctx)) {
      abort (); /* this really shouldn't happen */
    }
...
static void __attribute__((constructor)) __vapi_constructor_l3xc_dump()
{
  ...
  static vapi_message_desc_t __vapi_metadata_l3xc_dump = {
    ...
    (verify_msg_size_fn_t)vapi_verify_l3xc_dump_msg_size,
