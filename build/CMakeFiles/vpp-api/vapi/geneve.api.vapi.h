#ifndef __included_geneve_api_json
#define __included_geneve_api_json
...
extern vapi_msg_id_t vapi_msg_id_geneve_add_del_tunnel2;
extern vapi_msg_id_t vapi_msg_id_geneve_add_del_tunnel2_reply;
...
#define DEFINE_VAPI_MSG_IDS_GENEVE_API_JSON\
  ...
  vapi_msg_id_t vapi_msg_id_geneve_add_del_tunnel2;\
  vapi_msg_id_t vapi_msg_id_geneve_add_del_tunnel2_reply;\
...
static inline int vapi_verify_geneve_add_del_tunnel_reply_msg_size(vapi_msg_geneve_add_del_tunnel_reply *msg, uword buf_size)
{
  if (sizeof(vapi_msg_geneve_add_del_tunnel_reply) > buf_size)
    {
      VAPI_ERR("Truncated 'geneve_add_del_tunnel_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_geneve_add_del_tunnel_reply));
      return -1;
    }
  if (vapi_calc_geneve_add_del_tunnel_reply_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'geneve_add_del_tunnel_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_geneve_add_del_tunnel_reply_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_geneve_add_del_tunnel_reply()
{
  ...
  static const char name_with_crc[] = "geneve_add_del_tunnel_reply_5383d31f";
  static vapi_message_desc_t __vapi_metadata_geneve_add_del_tunnel_reply = {
    ...
    (verify_msg_size_fn_t)vapi_verify_geneve_add_del_tunnel_reply_msg_size,
...
typedef struct __attribute__ ((__packed__)) {
  bool is_add;
  vapi_type_address local_address;
  vapi_type_address remote_address;
...
static inline int vapi_verify_geneve_add_del_tunnel_msg_size(vapi_msg_geneve_add_del_tunnel *msg, uword buf_size)
{
  if (sizeof(vapi_msg_geneve_add_del_tunnel) > buf_size)
    {
      VAPI_ERR("Truncated 'geneve_add_del_tunnel' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_geneve_add_del_tunnel));
      return -1;
    }
  if (vapi_calc_geneve_add_del_tunnel_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'geneve_add_del_tunnel' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_geneve_add_del_tunnel_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send (ctx, msg))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_geneve_add_del_tunnel_reply, VAPI_REQUEST_REG, 
...
static void __attribute__((constructor)) __vapi_constructor_geneve_add_del_tunnel()
{
  ...
  static const char name_with_crc[] = "geneve_add_del_tunnel_99445831";
  static vapi_message_desc_t __vapi_metadata_geneve_add_del_tunnel = {
    ...
    (verify_msg_size_fn_t)vapi_verify_geneve_add_del_tunnel_msg_size,
...
#ifndef defined_vapi_msg_geneve_add_del_tunnel2_reply
#define defined_vapi_msg_geneve_add_del_tunnel2_reply
typedef struct __attribute__ ((__packed__)) {
  i32 retval;
  vapi_type_interface_index sw_if_index; 
} vapi_payload_geneve_add_del_tunnel2_reply;

typedef struct __attribute__ ((__packed__)) {
  vapi_type_msg_header1_t header;
  vapi_payload_geneve_add_del_tunnel2_reply payload;
} vapi_msg_geneve_add_del_tunnel2_reply;

static inline void vapi_msg_geneve_add_del_tunnel2_reply_payload_hton(vapi_payload_geneve_add_del_tunnel2_reply *payload)
{
  payload->retval = htobe32(payload->retval);
  payload->sw_if_index = htobe32(payload->sw_if_index);
}

static inline void vapi_msg_geneve_add_del_tunnel2_reply_payload_ntoh(vapi_payload_geneve_add_del_tunnel2_reply *payload)
{
  payload->retval = be32toh(payload->retval);
  payload->sw_if_index = be32toh(payload->sw_if_index);
}

static inline void vapi_msg_geneve_add_del_tunnel2_reply_hton(vapi_msg_geneve_add_del_tunnel2_reply *msg)
{
  VAPI_DBG("Swapping `vapi_msg_geneve_add_del_tunnel2_reply'@%p to big endian", msg);
  vapi_type_msg_header1_t_hton(&msg->header);
  vapi_msg_geneve_add_del_tunnel2_reply_payload_hton(&msg->payload);
}

static inline void vapi_msg_geneve_add_del_tunnel2_reply_ntoh(vapi_msg_geneve_add_del_tunnel2_reply *msg)
{
  VAPI_DBG("Swapping `vapi_msg_geneve_add_del_tunnel2_reply'@%p to host byte order", msg);
  vapi_type_msg_header1_t_ntoh(&msg->header);
  vapi_msg_geneve_add_del_tunnel2_reply_payload_ntoh(&msg->payload);
}

static inline uword vapi_calc_geneve_add_del_tunnel2_reply_msg_size(vapi_msg_geneve_add_del_tunnel2_reply *msg)
{
  return sizeof(*msg);
}

static inline int vapi_verify_geneve_add_del_tunnel2_reply_msg_size(vapi_msg_geneve_add_del_tunnel2_reply *msg, uword buf_size)
{
  if (sizeof(vapi_msg_geneve_add_del_tunnel2_reply) > buf_size)
    {
      VAPI_ERR("Truncated 'geneve_add_del_tunnel2_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_geneve_add_del_tunnel2_reply));
      return -1;
    }
  if (vapi_calc_geneve_add_del_tunnel2_reply_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'geneve_add_del_tunnel2_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_geneve_add_del_tunnel2_reply_msg_size(msg));
      return -1;
    }
  return 0;
}

static void __attribute__((constructor)) __vapi_constructor_geneve_add_del_tunnel2_reply()
{
  static const char name[] = "geneve_add_del_tunnel2_reply";
  static const char name_with_crc[] = "geneve_add_del_tunnel2_reply_5383d31f";
  static vapi_message_desc_t __vapi_metadata_geneve_add_del_tunnel2_reply = {
    name,
    sizeof(name) - 1,
    name_with_crc,
    sizeof(name_with_crc) - 1,
    true,
    offsetof(vapi_type_msg_header1_t, context),
    offsetof(vapi_msg_geneve_add_del_tunnel2_reply, payload),
    (verify_msg_size_fn_t)vapi_verify_geneve_add_del_tunnel2_reply_msg_size,
    (generic_swap_fn_t)vapi_msg_geneve_add_del_tunnel2_reply_hton,
    (generic_swap_fn_t)vapi_msg_geneve_add_del_tunnel2_reply_ntoh,
    VAPI_INVALID_MSG_ID,
  };

  vapi_msg_id_geneve_add_del_tunnel2_reply = vapi_register_msg(&__vapi_metadata_geneve_add_del_tunnel2_reply);
  VAPI_DBG("Assigned msg id %d to geneve_add_del_tunnel2_reply", vapi_msg_id_geneve_add_del_tunnel2_reply);
}

static inline void vapi_set_vapi_msg_geneve_add_del_tunnel2_reply_event_cb (
  struct vapi_ctx_s *ctx, 
  vapi_error_e (*callback)(struct vapi_ctx_s *ctx, void *callback_ctx, vapi_payload_geneve_add_del_tunnel2_reply *payload),
  void *callback_ctx)
{
  vapi_set_event_cb(ctx, vapi_msg_id_geneve_add_del_tunnel2_reply, (vapi_event_cb)callback, callback_ctx);
};
#endif

#ifndef defined_vapi_msg_geneve_add_del_tunnel2
#define defined_vapi_msg_geneve_add_del_tunnel2
typedef struct __attribute__ ((__packed__)) {
  bool is_add;
  vapi_type_address local_address;
  vapi_type_address remote_address;
  ...
  u32 vni;
  bool l3_mode; 
} vapi_payload_geneve_add_del_tunnel2;

typedef struct __attribute__ ((__packed__)) {
  vapi_type_msg_header2_t header;
  vapi_payload_geneve_add_del_tunnel2 payload;
} vapi_msg_geneve_add_del_tunnel2;

static inline void vapi_msg_geneve_add_del_tunnel2_payload_hton(vapi_payload_geneve_add_del_tunnel2 *payload)
{
  payload->mcast_sw_if_index = htobe32(payload->mcast_sw_if_index);
  payload->encap_vrf_id = htobe32(payload->encap_vrf_id);
  payload->decap_next_index = htobe32(payload->decap_next_index);
...
static inline void vapi_msg_geneve_add_del_tunnel2_payload_ntoh(vapi_payload_geneve_add_del_tunnel2 *payload)
{
  payload->mcast_sw_if_index = be32toh(payload->mcast_sw_if_index);
  payload->encap_vrf_id = be32toh(payload->encap_vrf_id);
  payload->decap_next_index = be32toh(payload->decap_next_index);
...
static inline void vapi_msg_geneve_add_del_tunnel2_hton(vapi_msg_geneve_add_del_tunnel2 *msg)
{
  VAPI_DBG("Swapping `vapi_msg_geneve_add_del_tunnel2'@%p to big endian", msg);
  vapi_type_msg_header2_t_hton(&msg->header);
  vapi_msg_geneve_add_del_tunnel2_payload_hton(&msg->payload);
}

static inline void vapi_msg_geneve_add_del_tunnel2_ntoh(vapi_msg_geneve_add_del_tunnel2 *msg)
{
  VAPI_DBG("Swapping `vapi_msg_geneve_add_del_tunnel2'@%p to host byte order", msg);
  vapi_type_msg_header2_t_ntoh(&msg->header);
  vapi_msg_geneve_add_del_tunnel2_payload_ntoh(&msg->payload);
}

static inline uword vapi_calc_geneve_add_del_tunnel2_msg_size(vapi_msg_geneve_add_del_tunnel2 *msg)
{
  return sizeof(*msg);
}

static inline int vapi_verify_geneve_add_del_tunnel2_msg_size(vapi_msg_geneve_add_del_tunnel2 *msg, uword buf_size)
{
  if (sizeof(vapi_msg_geneve_add_del_tunnel2) > buf_size)
    {
      VAPI_ERR("Truncated 'geneve_add_del_tunnel2' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_geneve_add_del_tunnel2));
      return -1;
    }
  if (vapi_calc_geneve_add_del_tunnel2_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'geneve_add_del_tunnel2' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_geneve_add_del_tunnel2_msg_size(msg));
      return -1;
    }
  return 0;
}

static inline vapi_msg_geneve_add_del_tunnel2* vapi_alloc_geneve_add_del_tunnel2(struct vapi_ctx_s *ctx)
{
  vapi_msg_geneve_add_del_tunnel2 *msg = NULL;
  const size_t size = sizeof(vapi_msg_geneve_add_del_tunnel2);
  /* cast here required to play nicely with C++ world ... */
  msg = (vapi_msg_geneve_add_del_tunnel2*)vapi_msg_alloc(ctx, size);
  if (!msg) {
    return NULL;
  }
  msg->header.client_index = vapi_get_client_index(ctx);
  msg->header.context = 0;
  msg->header._vl_msg_id = vapi_lookup_vl_msg_id(ctx, vapi_msg_id_geneve_add_del_tunnel2);

  return msg;
}

static inline vapi_error_e vapi_geneve_add_del_tunnel2(struct vapi_ctx_s *ctx,
  vapi_msg_geneve_add_del_tunnel2 *msg,
  vapi_error_e (*reply_callback)(struct vapi_ctx_s *ctx,
                                 void *callback_ctx,
                                 vapi_error_e rv,
                                 bool is_last,
                                 vapi_payload_geneve_add_del_tunnel2_reply *reply),
  void *reply_callback_ctx)
{
  if (!msg || !reply_callback) {
    return VAPI_EINVAL;
  ...
  if (VAPI_OK == (rv = vapi_send (ctx, msg))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_geneve_add_del_tunnel2_reply, VAPI_REQUEST_REG, 
                       (vapi_cb_t)reply_callback, reply_callback_ctx);
    if (VAPI_OK != vapi_producer_unlock (ctx)) {
      abort (); /* this really shouldn't happen */
    }
...
static void __attribute__((constructor)) __vapi_constructor_geneve_add_del_tunnel2()
{
  static const char name[] = "geneve_add_del_tunnel2";
  static const char name_with_crc[] = "geneve_add_del_tunnel2_8c2a9999";
  static vapi_message_desc_t __vapi_metadata_geneve_add_del_tunnel2 = {
    name,
    sizeof(name) - 1,
    name_with_crc,
    sizeof(name_with_crc) - 1,
    true,
    offsetof(vapi_type_msg_header2_t, context),
    offsetof(vapi_msg_geneve_add_del_tunnel2, payload),
    (verify_msg_size_fn_t)vapi_verify_geneve_add_del_tunnel2_msg_size,
    (generic_swap_fn_t)vapi_msg_geneve_add_del_tunnel2_hton,
    (generic_swap_fn_t)vapi_msg_geneve_add_del_tunnel2_ntoh,
    VAPI_INVALID_MSG_ID,
  };

  vapi_msg_id_geneve_add_del_tunnel2 = vapi_register_msg(&__vapi_metadata_geneve_add_del_tunnel2);
  VAPI_DBG("Assigned msg id %d to geneve_add_del_tunnel2", vapi_msg_id_geneve_add_del_tunnel2);
}
#endif
...
static inline int vapi_verify_geneve_tunnel_details_msg_size(vapi_msg_geneve_tunnel_details *msg, uword buf_size)
{
  if (sizeof(vapi_msg_geneve_tunnel_details) > buf_size)
    {
      VAPI_ERR("Truncated 'geneve_tunnel_details' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_geneve_tunnel_details));
      return -1;
    }
  if (vapi_calc_geneve_tunnel_details_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'geneve_tunnel_details' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_geneve_tunnel_details_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_geneve_tunnel_details()
{
  ...
  static const char name_with_crc[] = "geneve_tunnel_details_6b16eb24";
  static vapi_message_desc_t __vapi_metadata_geneve_tunnel_details = {
    ...
    (verify_msg_size_fn_t)vapi_verify_geneve_tunnel_details_msg_size,
...
static inline int vapi_verify_geneve_tunnel_dump_msg_size(vapi_msg_geneve_tunnel_dump *msg, uword buf_size)
{
  if (sizeof(vapi_msg_geneve_tunnel_dump) > buf_size)
    {
      VAPI_ERR("Truncated 'geneve_tunnel_dump' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_geneve_tunnel_dump));
      return -1;
    }
  if (vapi_calc_geneve_tunnel_dump_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'geneve_tunnel_dump' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_geneve_tunnel_dump_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send_with_control_ping (ctx, msg, req_context))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_geneve_tunnel_details, VAPI_REQUEST_DUMP, 
                       (vapi_cb_t)reply_callback, reply_callback_ctx);
    if (VAPI_OK != vapi_producer_unlock (ctx)) {
      abort (); /* this really shouldn't happen */
    }
...
static void __attribute__((constructor)) __vapi_constructor_geneve_tunnel_dump()
{
  ...
  static const char name_with_crc[] = "geneve_tunnel_dump_f9e6675e";
  static vapi_message_desc_t __vapi_metadata_geneve_tunnel_dump = {
    ...
    (verify_msg_size_fn_t)vapi_verify_geneve_tunnel_dump_msg_size,
...
static inline int vapi_verify_sw_interface_set_geneve_bypass_reply_msg_size(vapi_msg_sw_interface_set_geneve_bypass_reply *msg, uword buf_size)
{
  if (sizeof(vapi_msg_sw_interface_set_geneve_bypass_reply) > buf_size)
    {
      VAPI_ERR("Truncated 'sw_interface_set_geneve_bypass_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_sw_interface_set_geneve_bypass_reply));
      return -1;
    }
  if (vapi_calc_sw_interface_set_geneve_bypass_reply_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'sw_interface_set_geneve_bypass_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_sw_interface_set_geneve_bypass_reply_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_sw_interface_set_geneve_bypass_reply()
{
  ...
  static vapi_message_desc_t __vapi_metadata_sw_interface_set_geneve_bypass_reply = {
    ...
    (verify_msg_size_fn_t)vapi_verify_sw_interface_set_geneve_bypass_reply_msg_size,
...
static inline int vapi_verify_sw_interface_set_geneve_bypass_msg_size(vapi_msg_sw_interface_set_geneve_bypass *msg, uword buf_size)
{
  if (sizeof(vapi_msg_sw_interface_set_geneve_bypass) > buf_size)
    {
      VAPI_ERR("Truncated 'sw_interface_set_geneve_bypass' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_sw_interface_set_geneve_bypass));
      return -1;
    }
  if (vapi_calc_sw_interface_set_geneve_bypass_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'sw_interface_set_geneve_bypass' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_sw_interface_set_geneve_bypass_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send (ctx, msg))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_sw_interface_set_geneve_bypass_reply, VAPI_REQUEST_REG, 
                       (vapi_cb_t)reply_callback, reply_callback_ctx);
    if (VAPI_OK != vapi_producer_unlock (ctx)) {
      abort (); /* this really shouldn't happen */
    }
...
static void __attribute__((constructor)) __vapi_constructor_sw_interface_set_geneve_bypass()
{
  ...
  static const char name_with_crc[] = "sw_interface_set_geneve_bypass_65247409";
  static vapi_message_desc_t __vapi_metadata_sw_interface_set_geneve_bypass = {
    ...
    (verify_msg_size_fn_t)vapi_verify_sw_interface_set_geneve_bypass_msg_size,
