#ifndef __included_span_api_json
#define __included_span_api_json
...
static inline int vapi_verify_sw_interface_span_enable_disable_reply_msg_size(vapi_msg_sw_interface_span_enable_disable_reply *msg, uword buf_size)
{
  if (sizeof(vapi_msg_sw_interface_span_enable_disable_reply) > buf_size)
    {
      VAPI_ERR("Truncated 'sw_interface_span_enable_disable_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_sw_interface_span_enable_disable_reply));
      return -1;
    }
  if (vapi_calc_sw_interface_span_enable_disable_reply_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'sw_interface_span_enable_disable_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_sw_interface_span_enable_disable_reply_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_sw_interface_span_enable_disable_reply()
{
  ...
  static vapi_message_desc_t __vapi_metadata_sw_interface_span_enable_disable_reply = {
    ...
    (verify_msg_size_fn_t)vapi_verify_sw_interface_span_enable_disable_reply_msg_size,
...
static inline int vapi_verify_sw_interface_span_enable_disable_msg_size(vapi_msg_sw_interface_span_enable_disable *msg, uword buf_size)
{
  if (sizeof(vapi_msg_sw_interface_span_enable_disable) > buf_size)
    {
      VAPI_ERR("Truncated 'sw_interface_span_enable_disable' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_sw_interface_span_enable_disable));
      return -1;
    }
  if (vapi_calc_sw_interface_span_enable_disable_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'sw_interface_span_enable_disable' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_sw_interface_span_enable_disable_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send (ctx, msg))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_sw_interface_span_enable_disable_reply, VAPI_REQUEST_REG, 
...
static void __attribute__((constructor)) __vapi_constructor_sw_interface_span_enable_disable()
{
  ...
  static const char name_with_crc[] = "sw_interface_span_enable_disable_23ddd96b";
  static vapi_message_desc_t __vapi_metadata_sw_interface_span_enable_disable = {
    ...
    (verify_msg_size_fn_t)vapi_verify_sw_interface_span_enable_disable_msg_size,
...
static inline int vapi_verify_sw_interface_span_details_msg_size(vapi_msg_sw_interface_span_details *msg, uword buf_size)
{
  if (sizeof(vapi_msg_sw_interface_span_details) > buf_size)
    {
      VAPI_ERR("Truncated 'sw_interface_span_details' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_sw_interface_span_details));
      return -1;
    }
  if (vapi_calc_sw_interface_span_details_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'sw_interface_span_details' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_sw_interface_span_details_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_sw_interface_span_details()
{
  ...
  static const char name_with_crc[] = "sw_interface_span_details_8a20e79f";
  static vapi_message_desc_t __vapi_metadata_sw_interface_span_details = {
    ...
    (verify_msg_size_fn_t)vapi_verify_sw_interface_span_details_msg_size,
...
static inline int vapi_verify_sw_interface_span_dump_msg_size(vapi_msg_sw_interface_span_dump *msg, uword buf_size)
{
  if (sizeof(vapi_msg_sw_interface_span_dump) > buf_size)
    {
      VAPI_ERR("Truncated 'sw_interface_span_dump' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_sw_interface_span_dump));
      return -1;
    }
  if (vapi_calc_sw_interface_span_dump_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'sw_interface_span_dump' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_sw_interface_span_dump_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send_with_control_ping (ctx, msg, req_context))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_sw_interface_span_details, VAPI_REQUEST_DUMP, 
                       (vapi_cb_t)reply_callback, reply_callback_ctx);
    if (VAPI_OK != vapi_producer_unlock (ctx)) {
      abort (); /* this really shouldn't happen */
    }
...
static void __attribute__((constructor)) __vapi_constructor_sw_interface_span_dump()
{
  ...
  static vapi_message_desc_t __vapi_metadata_sw_interface_span_dump = {
    ...
    (verify_msg_size_fn_t)vapi_verify_sw_interface_span_dump_msg_size,
