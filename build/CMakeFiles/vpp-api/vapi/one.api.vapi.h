#ifndef __included_one_api_json
#define __included_one_api_json
...
#ifndef defined_vapi_enum_one_map_mode
#define defined_vapi_enum_one_map_mode
typedef enum {
  ONE_MAP_MODE_API_DST_ONLY = 0,
  ONE_MAP_MODE_API_SRC_DST = 1,
}  vapi_enum_one_map_mode;

#endif

#ifndef defined_vapi_enum_one_filter
#define defined_vapi_enum_one_filter
typedef enum {
  ONE_FILTER_API_ALL = 0,
  ONE_FILTER_API_LOCAL = 1,
  ONE_FILTER_API_REMOTE = 2,
}  vapi_enum_one_filter;
...
static inline int vapi_verify_one_add_del_locator_set_reply_msg_size(vapi_msg_one_add_del_locator_set_reply *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_add_del_locator_set_reply) > buf_size)
    {
      VAPI_ERR("Truncated 'one_add_del_locator_set_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_add_del_locator_set_reply));
      return -1;
    }
  if (vapi_calc_one_add_del_locator_set_reply_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_add_del_locator_set_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_add_del_locator_set_reply_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_one_add_del_locator_set_reply()
{
  ...
  static vapi_message_desc_t __vapi_metadata_one_add_del_locator_set_reply = {
    ...
    (verify_msg_size_fn_t)vapi_verify_one_add_del_locator_set_reply_msg_size,
...
static inline int vapi_verify_one_add_del_locator_set_msg_size(vapi_msg_one_add_del_locator_set *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_add_del_locator_set) > buf_size)
    {
      VAPI_ERR("Truncated 'one_add_del_locator_set' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_add_del_locator_set));
      return -1;
    }
  if (vapi_calc_one_add_del_locator_set_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_add_del_locator_set' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_add_del_locator_set_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send (ctx, msg))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_one_add_del_locator_set_reply, VAPI_REQUEST_REG, 
...
static void __attribute__((constructor)) __vapi_constructor_one_add_del_locator_set()
{
  ...
  static const char name_with_crc[] = "one_add_del_locator_set_6fcd6471";
  static vapi_message_desc_t __vapi_metadata_one_add_del_locator_set = {
    ...
    (verify_msg_size_fn_t)vapi_verify_one_add_del_locator_set_msg_size,
...
static inline int vapi_verify_one_add_del_locator_reply_msg_size(vapi_msg_one_add_del_locator_reply *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_add_del_locator_reply) > buf_size)
    {
      VAPI_ERR("Truncated 'one_add_del_locator_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_add_del_locator_reply));
      return -1;
    }
  if (vapi_calc_one_add_del_locator_reply_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_add_del_locator_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_add_del_locator_reply_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_one_add_del_locator_reply()
{
  ...
  static vapi_message_desc_t __vapi_metadata_one_add_del_locator_reply = {
    ...
    (verify_msg_size_fn_t)vapi_verify_one_add_del_locator_reply_msg_size,
...
static inline int vapi_verify_one_add_del_locator_msg_size(vapi_msg_one_add_del_locator *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_add_del_locator) > buf_size)
    {
      VAPI_ERR("Truncated 'one_add_del_locator' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_add_del_locator));
      return -1;
    }
  if (vapi_calc_one_add_del_locator_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_add_del_locator' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_add_del_locator_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send (ctx, msg))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_one_add_del_locator_reply, VAPI_REQUEST_REG, 
                       (vapi_cb_t)reply_callback, reply_callback_ctx);
    if (VAPI_OK != vapi_producer_unlock (ctx)) {
      abort (); /* this really shouldn't happen */
    }
...
static void __attribute__((constructor)) __vapi_constructor_one_add_del_locator()
{
  ...
  static const char name_with_crc[] = "one_add_del_locator_af4d8f13";
  static vapi_message_desc_t __vapi_metadata_one_add_del_locator = {
    ...
    (verify_msg_size_fn_t)vapi_verify_one_add_del_locator_msg_size,
...
static inline int vapi_verify_one_add_del_local_eid_reply_msg_size(vapi_msg_one_add_del_local_eid_reply *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_add_del_local_eid_reply) > buf_size)
    {
      VAPI_ERR("Truncated 'one_add_del_local_eid_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_add_del_local_eid_reply));
      return -1;
    }
  if (vapi_calc_one_add_del_local_eid_reply_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_add_del_local_eid_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_add_del_local_eid_reply_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_one_add_del_local_eid_reply()
{
  ...
  static vapi_message_desc_t __vapi_metadata_one_add_del_local_eid_reply = {
    ...
    (verify_msg_size_fn_t)vapi_verify_one_add_del_local_eid_reply_msg_size,
...
static inline int vapi_verify_one_add_del_local_eid_msg_size(vapi_msg_one_add_del_local_eid *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_add_del_local_eid) > buf_size)
    {
      VAPI_ERR("Truncated 'one_add_del_local_eid' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_add_del_local_eid));
      return -1;
    }
  if (vapi_calc_one_add_del_local_eid_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_add_del_local_eid' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_add_del_local_eid_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send (ctx, msg))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_one_add_del_local_eid_reply, VAPI_REQUEST_REG, 
                       (vapi_cb_t)reply_callback, reply_callback_ctx);
    if (VAPI_OK != vapi_producer_unlock (ctx)) {
      abort (); /* this really shouldn't happen */
    }
...
static void __attribute__((constructor)) __vapi_constructor_one_add_del_local_eid()
{
  ...
  static const char name_with_crc[] = "one_add_del_local_eid_4e5a83a2";
  static vapi_message_desc_t __vapi_metadata_one_add_del_local_eid = {
    ...
    (verify_msg_size_fn_t)vapi_verify_one_add_del_local_eid_msg_size,
...
static inline int vapi_verify_one_map_register_set_ttl_reply_msg_size(vapi_msg_one_map_register_set_ttl_reply *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_map_register_set_ttl_reply) > buf_size)
    {
      VAPI_ERR("Truncated 'one_map_register_set_ttl_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_map_register_set_ttl_reply));
      return -1;
    }
  if (vapi_calc_one_map_register_set_ttl_reply_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_map_register_set_ttl_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_map_register_set_ttl_reply_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_one_map_register_set_ttl_reply()
{
  ...
  static vapi_message_desc_t __vapi_metadata_one_map_register_set_ttl_reply = {
    ...
    (verify_msg_size_fn_t)vapi_verify_one_map_register_set_ttl_reply_msg_size,
...
static inline int vapi_verify_one_map_register_set_ttl_msg_size(vapi_msg_one_map_register_set_ttl *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_map_register_set_ttl) > buf_size)
    {
      VAPI_ERR("Truncated 'one_map_register_set_ttl' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_map_register_set_ttl));
      return -1;
    }
  if (vapi_calc_one_map_register_set_ttl_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_map_register_set_ttl' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_map_register_set_ttl_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send (ctx, msg))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_one_map_register_set_ttl_reply, VAPI_REQUEST_REG, 
                       (vapi_cb_t)reply_callback, reply_callback_ctx);
    if (VAPI_OK != vapi_producer_unlock (ctx)) {
      abort (); /* this really shouldn't happen */
    }
...
static void __attribute__((constructor)) __vapi_constructor_one_map_register_set_ttl()
{
  ...
  static vapi_message_desc_t __vapi_metadata_one_map_register_set_ttl = {
    ...
    (verify_msg_size_fn_t)vapi_verify_one_map_register_set_ttl_msg_size,
...
static inline int vapi_verify_show_one_map_register_ttl_reply_msg_size(vapi_msg_show_one_map_register_ttl_reply *msg, uword buf_size)
{
  if (sizeof(vapi_msg_show_one_map_register_ttl_reply) > buf_size)
    {
      VAPI_ERR("Truncated 'show_one_map_register_ttl_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_show_one_map_register_ttl_reply));
      return -1;
    }
  if (vapi_calc_show_one_map_register_ttl_reply_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'show_one_map_register_ttl_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_show_one_map_register_ttl_reply_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_show_one_map_register_ttl_reply()
{
  ...
  static vapi_message_desc_t __vapi_metadata_show_one_map_register_ttl_reply = {
    ...
    (verify_msg_size_fn_t)vapi_verify_show_one_map_register_ttl_reply_msg_size,
...
static inline int vapi_verify_show_one_map_register_ttl_msg_size(vapi_msg_show_one_map_register_ttl *msg, uword buf_size)
{
  if (sizeof(vapi_msg_show_one_map_register_ttl) > buf_size)
    {
      VAPI_ERR("Truncated 'show_one_map_register_ttl' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_show_one_map_register_ttl));
      return -1;
    }
  if (vapi_calc_show_one_map_register_ttl_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'show_one_map_register_ttl' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_show_one_map_register_ttl_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send (ctx, msg))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_show_one_map_register_ttl_reply, VAPI_REQUEST_REG, 
                       (vapi_cb_t)reply_callback, reply_callback_ctx);
    if (VAPI_OK != vapi_producer_unlock (ctx)) {
      abort (); /* this really shouldn't happen */
    }
...
static void __attribute__((constructor)) __vapi_constructor_show_one_map_register_ttl()
{
  ...
  static vapi_message_desc_t __vapi_metadata_show_one_map_register_ttl = {
    ...
    offsetof(vapi_type_msg_header2_t, context),
    VAPI_INVALID_MSG_ID,
    (verify_msg_size_fn_t)vapi_verify_show_one_map_register_ttl_msg_size,
...
static inline int vapi_verify_one_add_del_map_server_reply_msg_size(vapi_msg_one_add_del_map_server_reply *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_add_del_map_server_reply) > buf_size)
    {
      VAPI_ERR("Truncated 'one_add_del_map_server_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_add_del_map_server_reply));
      return -1;
    }
  if (vapi_calc_one_add_del_map_server_reply_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_add_del_map_server_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_add_del_map_server_reply_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_one_add_del_map_server_reply()
{
  ...
  static vapi_message_desc_t __vapi_metadata_one_add_del_map_server_reply = {
    ...
    (verify_msg_size_fn_t)vapi_verify_one_add_del_map_server_reply_msg_size,
...
static inline int vapi_verify_one_add_del_map_server_msg_size(vapi_msg_one_add_del_map_server *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_add_del_map_server) > buf_size)
    {
      VAPI_ERR("Truncated 'one_add_del_map_server' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_add_del_map_server));
      return -1;
    }
  if (vapi_calc_one_add_del_map_server_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_add_del_map_server' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_add_del_map_server_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send (ctx, msg))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_one_add_del_map_server_reply, VAPI_REQUEST_REG, 
                       (vapi_cb_t)reply_callback, reply_callback_ctx);
    if (VAPI_OK != vapi_producer_unlock (ctx)) {
      abort (); /* this really shouldn't happen */
    }
...
static void __attribute__((constructor)) __vapi_constructor_one_add_del_map_server()
{
  ...
  static const char name_with_crc[] = "one_add_del_map_server_ce19e32d";
  static vapi_message_desc_t __vapi_metadata_one_add_del_map_server = {
    ...
    (verify_msg_size_fn_t)vapi_verify_one_add_del_map_server_msg_size,
...
static inline int vapi_verify_one_add_del_map_resolver_reply_msg_size(vapi_msg_one_add_del_map_resolver_reply *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_add_del_map_resolver_reply) > buf_size)
    {
      VAPI_ERR("Truncated 'one_add_del_map_resolver_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_add_del_map_resolver_reply));
      return -1;
    }
  if (vapi_calc_one_add_del_map_resolver_reply_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_add_del_map_resolver_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_add_del_map_resolver_reply_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_one_add_del_map_resolver_reply()
{
  ...
  static vapi_message_desc_t __vapi_metadata_one_add_del_map_resolver_reply = {
    ...
    (verify_msg_size_fn_t)vapi_verify_one_add_del_map_resolver_reply_msg_size,
...
static inline int vapi_verify_one_add_del_map_resolver_msg_size(vapi_msg_one_add_del_map_resolver *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_add_del_map_resolver) > buf_size)
    {
      VAPI_ERR("Truncated 'one_add_del_map_resolver' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_add_del_map_resolver));
      return -1;
    }
  if (vapi_calc_one_add_del_map_resolver_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_add_del_map_resolver' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_add_del_map_resolver_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send (ctx, msg))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_one_add_del_map_resolver_reply, VAPI_REQUEST_REG, 
                       (vapi_cb_t)reply_callback, reply_callback_ctx);
    if (VAPI_OK != vapi_producer_unlock (ctx)) {
      abort (); /* this really shouldn't happen */
    }
...
static void __attribute__((constructor)) __vapi_constructor_one_add_del_map_resolver()
{
  ...
  static const char name_with_crc[] = "one_add_del_map_resolver_ce19e32d";
  static vapi_message_desc_t __vapi_metadata_one_add_del_map_resolver = {
    ...
    (verify_msg_size_fn_t)vapi_verify_one_add_del_map_resolver_msg_size,
...
static inline int vapi_verify_one_enable_disable_reply_msg_size(vapi_msg_one_enable_disable_reply *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_enable_disable_reply) > buf_size)
    {
      VAPI_ERR("Truncated 'one_enable_disable_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_enable_disable_reply));
      return -1;
    }
  if (vapi_calc_one_enable_disable_reply_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_enable_disable_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_enable_disable_reply_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_one_enable_disable_reply()
{
  ...
  static vapi_message_desc_t __vapi_metadata_one_enable_disable_reply = {
    ...
    (verify_msg_size_fn_t)vapi_verify_one_enable_disable_reply_msg_size,
...
static inline int vapi_verify_one_enable_disable_msg_size(vapi_msg_one_enable_disable *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_enable_disable) > buf_size)
    {
      VAPI_ERR("Truncated 'one_enable_disable' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_enable_disable));
      return -1;
    }
  if (vapi_calc_one_enable_disable_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_enable_disable' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_enable_disable_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send (ctx, msg))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_one_enable_disable_reply, VAPI_REQUEST_REG, 
                       (vapi_cb_t)reply_callback, reply_callback_ctx);
    if (VAPI_OK != vapi_producer_unlock (ctx)) {
      abort (); /* this really shouldn't happen */
    }
...
static void __attribute__((constructor)) __vapi_constructor_one_enable_disable()
{
  ...
  static const char name_with_crc[] = "one_enable_disable_c264d7bf";
  static vapi_message_desc_t __vapi_metadata_one_enable_disable = {
    ...
    (verify_msg_size_fn_t)vapi_verify_one_enable_disable_msg_size,
...
static inline int vapi_verify_one_nsh_set_locator_set_reply_msg_size(vapi_msg_one_nsh_set_locator_set_reply *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_nsh_set_locator_set_reply) > buf_size)
    {
      VAPI_ERR("Truncated 'one_nsh_set_locator_set_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_nsh_set_locator_set_reply));
      return -1;
    }
  if (vapi_calc_one_nsh_set_locator_set_reply_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_nsh_set_locator_set_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_nsh_set_locator_set_reply_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_one_nsh_set_locator_set_reply()
{
  ...
  static vapi_message_desc_t __vapi_metadata_one_nsh_set_locator_set_reply = {
    ...
    (verify_msg_size_fn_t)vapi_verify_one_nsh_set_locator_set_reply_msg_size,
...
static inline int vapi_verify_one_nsh_set_locator_set_msg_size(vapi_msg_one_nsh_set_locator_set *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_nsh_set_locator_set) > buf_size)
    {
      VAPI_ERR("Truncated 'one_nsh_set_locator_set' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_nsh_set_locator_set));
      return -1;
    }
  if (vapi_calc_one_nsh_set_locator_set_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_nsh_set_locator_set' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_nsh_set_locator_set_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send (ctx, msg))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_one_nsh_set_locator_set_reply, VAPI_REQUEST_REG, 
                       (vapi_cb_t)reply_callback, reply_callback_ctx);
    if (VAPI_OK != vapi_producer_unlock (ctx)) {
      abort (); /* this really shouldn't happen */
    }
...
static void __attribute__((constructor)) __vapi_constructor_one_nsh_set_locator_set()
{
  ...
  static const char name_with_crc[] = "one_nsh_set_locator_set_486e2b76";
  static vapi_message_desc_t __vapi_metadata_one_nsh_set_locator_set = {
    ...
    (verify_msg_size_fn_t)vapi_verify_one_nsh_set_locator_set_msg_size,
...
static inline int vapi_verify_one_pitr_set_locator_set_reply_msg_size(vapi_msg_one_pitr_set_locator_set_reply *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_pitr_set_locator_set_reply) > buf_size)
    {
      VAPI_ERR("Truncated 'one_pitr_set_locator_set_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_pitr_set_locator_set_reply));
      return -1;
    }
  if (vapi_calc_one_pitr_set_locator_set_reply_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_pitr_set_locator_set_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_pitr_set_locator_set_reply_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_one_pitr_set_locator_set_reply()
{
  ...
  static vapi_message_desc_t __vapi_metadata_one_pitr_set_locator_set_reply = {
    ...
    (verify_msg_size_fn_t)vapi_verify_one_pitr_set_locator_set_reply_msg_size,
...
static inline int vapi_verify_one_pitr_set_locator_set_msg_size(vapi_msg_one_pitr_set_locator_set *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_pitr_set_locator_set) > buf_size)
    {
      VAPI_ERR("Truncated 'one_pitr_set_locator_set' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_pitr_set_locator_set));
      return -1;
    }
  if (vapi_calc_one_pitr_set_locator_set_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_pitr_set_locator_set' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_pitr_set_locator_set_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send (ctx, msg))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_one_pitr_set_locator_set_reply, VAPI_REQUEST_REG, 
                       (vapi_cb_t)reply_callback, reply_callback_ctx);
    if (VAPI_OK != vapi_producer_unlock (ctx)) {
      abort (); /* this really shouldn't happen */
    }
...
static void __attribute__((constructor)) __vapi_constructor_one_pitr_set_locator_set()
{
  ...
  static const char name_with_crc[] = "one_pitr_set_locator_set_486e2b76";
  static vapi_message_desc_t __vapi_metadata_one_pitr_set_locator_set = {
    ...
    (verify_msg_size_fn_t)vapi_verify_one_pitr_set_locator_set_msg_size,
...
static inline int vapi_verify_one_use_petr_reply_msg_size(vapi_msg_one_use_petr_reply *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_use_petr_reply) > buf_size)
    {
      VAPI_ERR("Truncated 'one_use_petr_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_use_petr_reply));
      return -1;
    }
  if (vapi_calc_one_use_petr_reply_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_use_petr_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_use_petr_reply_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_one_use_petr_reply()
{
  ...
  static vapi_message_desc_t __vapi_metadata_one_use_petr_reply = {
    ...
    (verify_msg_size_fn_t)vapi_verify_one_use_petr_reply_msg_size,
...
static inline int vapi_verify_one_use_petr_msg_size(vapi_msg_one_use_petr *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_use_petr) > buf_size)
    {
      VAPI_ERR("Truncated 'one_use_petr' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_use_petr));
      return -1;
    }
  if (vapi_calc_one_use_petr_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_use_petr' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_use_petr_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send (ctx, msg))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_one_use_petr_reply, VAPI_REQUEST_REG, 
                       (vapi_cb_t)reply_callback, reply_callback_ctx);
    if (VAPI_OK != vapi_producer_unlock (ctx)) {
      abort (); /* this really shouldn't happen */
    }
...
static void __attribute__((constructor)) __vapi_constructor_one_use_petr()
{
  ...
  static const char name_with_crc[] = "one_use_petr_d87dbad9";
  static vapi_message_desc_t __vapi_metadata_one_use_petr = {
    ...
    (verify_msg_size_fn_t)vapi_verify_one_use_petr_msg_size,
...
static inline int vapi_verify_show_one_use_petr_reply_msg_size(vapi_msg_show_one_use_petr_reply *msg, uword buf_size)
{
  if (sizeof(vapi_msg_show_one_use_petr_reply) > buf_size)
    {
      VAPI_ERR("Truncated 'show_one_use_petr_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_show_one_use_petr_reply));
      return -1;
    }
  if (vapi_calc_show_one_use_petr_reply_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'show_one_use_petr_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_show_one_use_petr_reply_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_show_one_use_petr_reply()
{
  ...
  static const char name_with_crc[] = "show_one_use_petr_reply_84a03528";
  static vapi_message_desc_t __vapi_metadata_show_one_use_petr_reply = {
    ...
    (verify_msg_size_fn_t)vapi_verify_show_one_use_petr_reply_msg_size,
...
static inline int vapi_verify_show_one_use_petr_msg_size(vapi_msg_show_one_use_petr *msg, uword buf_size)
{
  if (sizeof(vapi_msg_show_one_use_petr) > buf_size)
    {
      VAPI_ERR("Truncated 'show_one_use_petr' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_show_one_use_petr));
      return -1;
    }
  if (vapi_calc_show_one_use_petr_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'show_one_use_petr' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_show_one_use_petr_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send (ctx, msg))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_show_one_use_petr_reply, VAPI_REQUEST_REG, 
                       (vapi_cb_t)reply_callback, reply_callback_ctx);
    if (VAPI_OK != vapi_producer_unlock (ctx)) {
      abort (); /* this really shouldn't happen */
    }
...
static void __attribute__((constructor)) __vapi_constructor_show_one_use_petr()
{
  ...
  static vapi_message_desc_t __vapi_metadata_show_one_use_petr = {
    ...
    offsetof(vapi_type_msg_header2_t, context),
    VAPI_INVALID_MSG_ID,
    (verify_msg_size_fn_t)vapi_verify_show_one_use_petr_msg_size,
...
static inline int vapi_verify_show_one_rloc_probe_state_reply_msg_size(vapi_msg_show_one_rloc_probe_state_reply *msg, uword buf_size)
{
  if (sizeof(vapi_msg_show_one_rloc_probe_state_reply) > buf_size)
    {
      VAPI_ERR("Truncated 'show_one_rloc_probe_state_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_show_one_rloc_probe_state_reply));
      return -1;
    }
  if (vapi_calc_show_one_rloc_probe_state_reply_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'show_one_rloc_probe_state_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_show_one_rloc_probe_state_reply_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_show_one_rloc_probe_state_reply()
{
  ...
  static const char name_with_crc[] = "show_one_rloc_probe_state_reply_f15abb16";
  static vapi_message_desc_t __vapi_metadata_show_one_rloc_probe_state_reply = {
    ...
    (verify_msg_size_fn_t)vapi_verify_show_one_rloc_probe_state_reply_msg_size,
...
static inline int vapi_verify_show_one_rloc_probe_state_msg_size(vapi_msg_show_one_rloc_probe_state *msg, uword buf_size)
{
  if (sizeof(vapi_msg_show_one_rloc_probe_state) > buf_size)
    {
      VAPI_ERR("Truncated 'show_one_rloc_probe_state' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_show_one_rloc_probe_state));
      return -1;
    }
  if (vapi_calc_show_one_rloc_probe_state_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'show_one_rloc_probe_state' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_show_one_rloc_probe_state_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send (ctx, msg))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_show_one_rloc_probe_state_reply, VAPI_REQUEST_REG, 
                       (vapi_cb_t)reply_callback, reply_callback_ctx);
    if (VAPI_OK != vapi_producer_unlock (ctx)) {
      abort (); /* this really shouldn't happen */
    }
...
static void __attribute__((constructor)) __vapi_constructor_show_one_rloc_probe_state()
{
  ...
  static vapi_message_desc_t __vapi_metadata_show_one_rloc_probe_state = {
    ...
    offsetof(vapi_type_msg_header2_t, context),
    VAPI_INVALID_MSG_ID,
    (verify_msg_size_fn_t)vapi_verify_show_one_rloc_probe_state_msg_size,
...
static inline int vapi_verify_one_rloc_probe_enable_disable_reply_msg_size(vapi_msg_one_rloc_probe_enable_disable_reply *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_rloc_probe_enable_disable_reply) > buf_size)
    {
      VAPI_ERR("Truncated 'one_rloc_probe_enable_disable_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_rloc_probe_enable_disable_reply));
      return -1;
    }
  if (vapi_calc_one_rloc_probe_enable_disable_reply_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_rloc_probe_enable_disable_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_rloc_probe_enable_disable_reply_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_one_rloc_probe_enable_disable_reply()
{
  ...
  static vapi_message_desc_t __vapi_metadata_one_rloc_probe_enable_disable_reply = {
    ...
    (verify_msg_size_fn_t)vapi_verify_one_rloc_probe_enable_disable_reply_msg_size,
...
static inline int vapi_verify_one_rloc_probe_enable_disable_msg_size(vapi_msg_one_rloc_probe_enable_disable *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_rloc_probe_enable_disable) > buf_size)
    {
      VAPI_ERR("Truncated 'one_rloc_probe_enable_disable' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_rloc_probe_enable_disable));
      return -1;
    }
  if (vapi_calc_one_rloc_probe_enable_disable_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_rloc_probe_enable_disable' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_rloc_probe_enable_disable_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send (ctx, msg))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_one_rloc_probe_enable_disable_reply, VAPI_REQUEST_REG, 
                       (vapi_cb_t)reply_callback, reply_callback_ctx);
    if (VAPI_OK != vapi_producer_unlock (ctx)) {
      abort (); /* this really shouldn't happen */
    }
...
static void __attribute__((constructor)) __vapi_constructor_one_rloc_probe_enable_disable()
{
  ...
  static const char name_with_crc[] = "one_rloc_probe_enable_disable_c264d7bf";
  static vapi_message_desc_t __vapi_metadata_one_rloc_probe_enable_disable = {
    ...
    (verify_msg_size_fn_t)vapi_verify_one_rloc_probe_enable_disable_msg_size,
...
static inline int vapi_verify_one_map_register_enable_disable_reply_msg_size(vapi_msg_one_map_register_enable_disable_reply *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_map_register_enable_disable_reply) > buf_size)
    {
      VAPI_ERR("Truncated 'one_map_register_enable_disable_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_map_register_enable_disable_reply));
      return -1;
    }
  if (vapi_calc_one_map_register_enable_disable_reply_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_map_register_enable_disable_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_map_register_enable_disable_reply_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_one_map_register_enable_disable_reply()
{
  ...
  static vapi_message_desc_t __vapi_metadata_one_map_register_enable_disable_reply = {
    ...
    (verify_msg_size_fn_t)vapi_verify_one_map_register_enable_disable_reply_msg_size,
...
static inline int vapi_verify_one_map_register_enable_disable_msg_size(vapi_msg_one_map_register_enable_disable *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_map_register_enable_disable) > buf_size)
    {
      VAPI_ERR("Truncated 'one_map_register_enable_disable' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_map_register_enable_disable));
      return -1;
    }
  if (vapi_calc_one_map_register_enable_disable_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_map_register_enable_disable' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_map_register_enable_disable_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send (ctx, msg))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_one_map_register_enable_disable_reply, VAPI_REQUEST_REG, 
                       (vapi_cb_t)reply_callback, reply_callback_ctx);
    if (VAPI_OK != vapi_producer_unlock (ctx)) {
      abort (); /* this really shouldn't happen */
    }
...
static void __attribute__((constructor)) __vapi_constructor_one_map_register_enable_disable()
{
  ...
  static const char name_with_crc[] = "one_map_register_enable_disable_c264d7bf";
  static vapi_message_desc_t __vapi_metadata_one_map_register_enable_disable = {
    ...
    (verify_msg_size_fn_t)vapi_verify_one_map_register_enable_disable_msg_size,
...
static inline int vapi_verify_show_one_map_register_state_reply_msg_size(vapi_msg_show_one_map_register_state_reply *msg, uword buf_size)
{
  if (sizeof(vapi_msg_show_one_map_register_state_reply) > buf_size)
    {
      VAPI_ERR("Truncated 'show_one_map_register_state_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_show_one_map_register_state_reply));
      return -1;
    }
  if (vapi_calc_show_one_map_register_state_reply_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'show_one_map_register_state_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_show_one_map_register_state_reply_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_show_one_map_register_state_reply()
{
  ...
  static const char name_with_crc[] = "show_one_map_register_state_reply_f15abb16";
  static vapi_message_desc_t __vapi_metadata_show_one_map_register_state_reply = {
    ...
    (verify_msg_size_fn_t)vapi_verify_show_one_map_register_state_reply_msg_size,
...
static inline int vapi_verify_show_one_map_register_state_msg_size(vapi_msg_show_one_map_register_state *msg, uword buf_size)
{
  if (sizeof(vapi_msg_show_one_map_register_state) > buf_size)
    {
      VAPI_ERR("Truncated 'show_one_map_register_state' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_show_one_map_register_state));
      return -1;
    }
  if (vapi_calc_show_one_map_register_state_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'show_one_map_register_state' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_show_one_map_register_state_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send (ctx, msg))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_show_one_map_register_state_reply, VAPI_REQUEST_REG, 
                       (vapi_cb_t)reply_callback, reply_callback_ctx);
    if (VAPI_OK != vapi_producer_unlock (ctx)) {
      abort (); /* this really shouldn't happen */
    }
...
static void __attribute__((constructor)) __vapi_constructor_show_one_map_register_state()
{
  ...
  static vapi_message_desc_t __vapi_metadata_show_one_map_register_state = {
    ...
    offsetof(vapi_type_msg_header2_t, context),
    VAPI_INVALID_MSG_ID,
    (verify_msg_size_fn_t)vapi_verify_show_one_map_register_state_msg_size,
...
static inline int vapi_verify_one_map_request_mode_reply_msg_size(vapi_msg_one_map_request_mode_reply *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_map_request_mode_reply) > buf_size)
    {
      VAPI_ERR("Truncated 'one_map_request_mode_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_map_request_mode_reply));
      return -1;
    }
  if (vapi_calc_one_map_request_mode_reply_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_map_request_mode_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_map_request_mode_reply_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_one_map_request_mode_reply()
{
  ...
  static vapi_message_desc_t __vapi_metadata_one_map_request_mode_reply = {
    ...
    (verify_msg_size_fn_t)vapi_verify_one_map_request_mode_reply_msg_size,
...
{
  payload->mode = (vapi_enum_one_map_mode)htobe32(payload->mode);
}

static inline void vapi_msg_one_map_request_mode_payload_ntoh(vapi_payload_one_map_request_mode *payload)
{
  payload->mode = (vapi_enum_one_map_mode)be32toh(payload->mode);
}
...
static inline int vapi_verify_one_map_request_mode_msg_size(vapi_msg_one_map_request_mode *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_map_request_mode) > buf_size)
    {
      VAPI_ERR("Truncated 'one_map_request_mode' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_map_request_mode));
      return -1;
    }
  if (vapi_calc_one_map_request_mode_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_map_request_mode' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_map_request_mode_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send (ctx, msg))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_one_map_request_mode_reply, VAPI_REQUEST_REG, 
                       (vapi_cb_t)reply_callback, reply_callback_ctx);
    if (VAPI_OK != vapi_producer_unlock (ctx)) {
      abort (); /* this really shouldn't happen */
    }
...
static void __attribute__((constructor)) __vapi_constructor_one_map_request_mode()
{
  ...
  static const char name_with_crc[] = "one_map_request_mode_ffa5d2f5";
  static vapi_message_desc_t __vapi_metadata_one_map_request_mode = {
    ...
    (verify_msg_size_fn_t)vapi_verify_one_map_request_mode_msg_size,
...
static inline int vapi_verify_show_one_map_request_mode_reply_msg_size(vapi_msg_show_one_map_request_mode_reply *msg, uword buf_size)
{
  if (sizeof(vapi_msg_show_one_map_request_mode_reply) > buf_size)
    {
      VAPI_ERR("Truncated 'show_one_map_request_mode_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_show_one_map_request_mode_reply));
      return -1;
    }
  if (vapi_calc_show_one_map_request_mode_reply_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'show_one_map_request_mode_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_show_one_map_request_mode_reply_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_show_one_map_request_mode_reply()
{
  ...
  static const char name_with_crc[] = "show_one_map_request_mode_reply_d41f3c1d";
  static vapi_message_desc_t __vapi_metadata_show_one_map_request_mode_reply = {
    ...
    (verify_msg_size_fn_t)vapi_verify_show_one_map_request_mode_reply_msg_size,
...
static inline int vapi_verify_show_one_map_request_mode_msg_size(vapi_msg_show_one_map_request_mode *msg, uword buf_size)
{
  if (sizeof(vapi_msg_show_one_map_request_mode) > buf_size)
    {
      VAPI_ERR("Truncated 'show_one_map_request_mode' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_show_one_map_request_mode));
      return -1;
    }
  if (vapi_calc_show_one_map_request_mode_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'show_one_map_request_mode' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_show_one_map_request_mode_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send (ctx, msg))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_show_one_map_request_mode_reply, VAPI_REQUEST_REG, 
                       (vapi_cb_t)reply_callback, reply_callback_ctx);
    if (VAPI_OK != vapi_producer_unlock (ctx)) {
      abort (); /* this really shouldn't happen */
    }
...
static void __attribute__((constructor)) __vapi_constructor_show_one_map_request_mode()
{
  ...
  static vapi_message_desc_t __vapi_metadata_show_one_map_request_mode = {
    ...
    offsetof(vapi_type_msg_header2_t, context),
    VAPI_INVALID_MSG_ID,
    (verify_msg_size_fn_t)vapi_verify_show_one_map_request_mode_msg_size,
...
static inline int vapi_verify_one_add_del_remote_mapping_reply_msg_size(vapi_msg_one_add_del_remote_mapping_reply *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_add_del_remote_mapping_reply) > buf_size)
    {
      VAPI_ERR("Truncated 'one_add_del_remote_mapping_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_add_del_remote_mapping_reply));
      return -1;
    }
  if (vapi_calc_one_add_del_remote_mapping_reply_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_add_del_remote_mapping_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_add_del_remote_mapping_reply_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_one_add_del_remote_mapping_reply()
{
  ...
  static vapi_message_desc_t __vapi_metadata_one_add_del_remote_mapping_reply = {
    ...
    (verify_msg_size_fn_t)vapi_verify_one_add_del_remote_mapping_reply_msg_size,
...
static inline int vapi_verify_one_add_del_remote_mapping_msg_size(vapi_msg_one_add_del_remote_mapping *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_add_del_remote_mapping) > buf_size)
    {
      VAPI_ERR("Truncated 'one_add_del_remote_mapping' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_add_del_remote_mapping));
      return -1;
    }
  if (vapi_calc_one_add_del_remote_mapping_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_add_del_remote_mapping' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_add_del_remote_mapping_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send (ctx, msg))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_one_add_del_remote_mapping_reply, VAPI_REQUEST_REG, 
                       (vapi_cb_t)reply_callback, reply_callback_ctx);
    if (VAPI_OK != vapi_producer_unlock (ctx)) {
      abort (); /* this really shouldn't happen */
    }
...
static void __attribute__((constructor)) __vapi_constructor_one_add_del_remote_mapping()
{
  ...
  static const char name_with_crc[] = "one_add_del_remote_mapping_6d5c789e";
  static vapi_message_desc_t __vapi_metadata_one_add_del_remote_mapping = {
    ...
    (verify_msg_size_fn_t)vapi_verify_one_add_del_remote_mapping_msg_size,
...
static inline int vapi_verify_one_add_del_l2_arp_entry_reply_msg_size(vapi_msg_one_add_del_l2_arp_entry_reply *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_add_del_l2_arp_entry_reply) > buf_size)
    {
      VAPI_ERR("Truncated 'one_add_del_l2_arp_entry_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_add_del_l2_arp_entry_reply));
      return -1;
    }
  if (vapi_calc_one_add_del_l2_arp_entry_reply_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_add_del_l2_arp_entry_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_add_del_l2_arp_entry_reply_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_one_add_del_l2_arp_entry_reply()
{
  ...
  static vapi_message_desc_t __vapi_metadata_one_add_del_l2_arp_entry_reply = {
    ...
    (verify_msg_size_fn_t)vapi_verify_one_add_del_l2_arp_entry_reply_msg_size,
...
typedef struct __attribute__ ((__packed__)) {
  bool is_add;
  u32 bd;
  vapi_type_one_l2_arp_entry entry; 
...
static inline int vapi_verify_one_add_del_l2_arp_entry_msg_size(vapi_msg_one_add_del_l2_arp_entry *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_add_del_l2_arp_entry) > buf_size)
    {
      VAPI_ERR("Truncated 'one_add_del_l2_arp_entry' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_add_del_l2_arp_entry));
      return -1;
    }
  if (vapi_calc_one_add_del_l2_arp_entry_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_add_del_l2_arp_entry' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_add_del_l2_arp_entry_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send (ctx, msg))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_one_add_del_l2_arp_entry_reply, VAPI_REQUEST_REG, 
                       (vapi_cb_t)reply_callback, reply_callback_ctx);
    if (VAPI_OK != vapi_producer_unlock (ctx)) {
      abort (); /* this really shouldn't happen */
    }
...
static void __attribute__((constructor)) __vapi_constructor_one_add_del_l2_arp_entry()
{
  ...
  static const char name_with_crc[] = "one_add_del_l2_arp_entry_1aa5e8b3";
  static vapi_message_desc_t __vapi_metadata_one_add_del_l2_arp_entry = {
    ...
    (verify_msg_size_fn_t)vapi_verify_one_add_del_l2_arp_entry_msg_size,
...
static inline int vapi_verify_one_l2_arp_entries_get_reply_msg_size(vapi_msg_one_l2_arp_entries_get_reply *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_l2_arp_entries_get_reply) > buf_size)
    {
      VAPI_ERR("Truncated 'one_l2_arp_entries_get_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_l2_arp_entries_get_reply));
      return -1;
    }
  if (vapi_calc_one_l2_arp_entries_get_reply_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_l2_arp_entries_get_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_l2_arp_entries_get_reply_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_one_l2_arp_entries_get_reply()
{
  ...
  static const char name_with_crc[] = "one_l2_arp_entries_get_reply_b0dd200f";
  static vapi_message_desc_t __vapi_metadata_one_l2_arp_entries_get_reply = {
    ...
    (verify_msg_size_fn_t)vapi_verify_one_l2_arp_entries_get_reply_msg_size,
...
static inline int vapi_verify_one_l2_arp_entries_get_msg_size(vapi_msg_one_l2_arp_entries_get *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_l2_arp_entries_get) > buf_size)
    {
      VAPI_ERR("Truncated 'one_l2_arp_entries_get' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_l2_arp_entries_get));
      return -1;
    }
  if (vapi_calc_one_l2_arp_entries_get_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_l2_arp_entries_get' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_l2_arp_entries_get_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send (ctx, msg))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_one_l2_arp_entries_get_reply, VAPI_REQUEST_REG, 
                       (vapi_cb_t)reply_callback, reply_callback_ctx);
    if (VAPI_OK != vapi_producer_unlock (ctx)) {
      abort (); /* this really shouldn't happen */
    }
...
static void __attribute__((constructor)) __vapi_constructor_one_l2_arp_entries_get()
{
  ...
  static vapi_message_desc_t __vapi_metadata_one_l2_arp_entries_get = {
    ...
    (verify_msg_size_fn_t)vapi_verify_one_l2_arp_entries_get_msg_size,
...
static inline int vapi_verify_one_add_del_ndp_entry_reply_msg_size(vapi_msg_one_add_del_ndp_entry_reply *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_add_del_ndp_entry_reply) > buf_size)
    {
      VAPI_ERR("Truncated 'one_add_del_ndp_entry_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_add_del_ndp_entry_reply));
      return -1;
    }
  if (vapi_calc_one_add_del_ndp_entry_reply_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_add_del_ndp_entry_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_add_del_ndp_entry_reply_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_one_add_del_ndp_entry_reply()
{
  ...
  static vapi_message_desc_t __vapi_metadata_one_add_del_ndp_entry_reply = {
    ...
    (verify_msg_size_fn_t)vapi_verify_one_add_del_ndp_entry_reply_msg_size,
...
static inline int vapi_verify_one_add_del_ndp_entry_msg_size(vapi_msg_one_add_del_ndp_entry *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_add_del_ndp_entry) > buf_size)
    {
      VAPI_ERR("Truncated 'one_add_del_ndp_entry' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_add_del_ndp_entry));
      return -1;
    }
  if (vapi_calc_one_add_del_ndp_entry_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_add_del_ndp_entry' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_add_del_ndp_entry_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send (ctx, msg))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_one_add_del_ndp_entry_reply, VAPI_REQUEST_REG, 
                       (vapi_cb_t)reply_callback, reply_callback_ctx);
    if (VAPI_OK != vapi_producer_unlock (ctx)) {
      abort (); /* this really shouldn't happen */
    }
...
static void __attribute__((constructor)) __vapi_constructor_one_add_del_ndp_entry()
{
  ...
  static const char name_with_crc[] = "one_add_del_ndp_entry_0f8a287c";
  static vapi_message_desc_t __vapi_metadata_one_add_del_ndp_entry = {
    ...
    (verify_msg_size_fn_t)vapi_verify_one_add_del_ndp_entry_msg_size,
...
static inline int vapi_verify_one_ndp_entries_get_reply_msg_size(vapi_msg_one_ndp_entries_get_reply *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_ndp_entries_get_reply) > buf_size)
    {
      VAPI_ERR("Truncated 'one_ndp_entries_get_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_ndp_entries_get_reply));
      return -1;
    }
  if (vapi_calc_one_ndp_entries_get_reply_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_ndp_entries_get_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_ndp_entries_get_reply_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_one_ndp_entries_get_reply()
{
  ...
  static const char name_with_crc[] = "one_ndp_entries_get_reply_70719b1a";
  static vapi_message_desc_t __vapi_metadata_one_ndp_entries_get_reply = {
    ...
    (verify_msg_size_fn_t)vapi_verify_one_ndp_entries_get_reply_msg_size,
...
static inline int vapi_verify_one_ndp_entries_get_msg_size(vapi_msg_one_ndp_entries_get *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_ndp_entries_get) > buf_size)
    {
      VAPI_ERR("Truncated 'one_ndp_entries_get' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_ndp_entries_get));
      return -1;
    }
  if (vapi_calc_one_ndp_entries_get_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_ndp_entries_get' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_ndp_entries_get_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send (ctx, msg))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_one_ndp_entries_get_reply, VAPI_REQUEST_REG, 
                       (vapi_cb_t)reply_callback, reply_callback_ctx);
    if (VAPI_OK != vapi_producer_unlock (ctx)) {
      abort (); /* this really shouldn't happen */
    }
...
static void __attribute__((constructor)) __vapi_constructor_one_ndp_entries_get()
{
  ...
  static vapi_message_desc_t __vapi_metadata_one_ndp_entries_get = {
    ...
    (verify_msg_size_fn_t)vapi_verify_one_ndp_entries_get_msg_size,
...
static inline int vapi_verify_one_set_transport_protocol_reply_msg_size(vapi_msg_one_set_transport_protocol_reply *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_set_transport_protocol_reply) > buf_size)
    {
      VAPI_ERR("Truncated 'one_set_transport_protocol_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_set_transport_protocol_reply));
      return -1;
    }
  if (vapi_calc_one_set_transport_protocol_reply_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_set_transport_protocol_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_set_transport_protocol_reply_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_one_set_transport_protocol_reply()
{
  ...
  static vapi_message_desc_t __vapi_metadata_one_set_transport_protocol_reply = {
    ...
    (verify_msg_size_fn_t)vapi_verify_one_set_transport_protocol_reply_msg_size,
...
static inline int vapi_verify_one_set_transport_protocol_msg_size(vapi_msg_one_set_transport_protocol *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_set_transport_protocol) > buf_size)
    {
      VAPI_ERR("Truncated 'one_set_transport_protocol' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_set_transport_protocol));
      return -1;
    }
  if (vapi_calc_one_set_transport_protocol_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_set_transport_protocol' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_set_transport_protocol_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send (ctx, msg))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_one_set_transport_protocol_reply, VAPI_REQUEST_REG, 
                       (vapi_cb_t)reply_callback, reply_callback_ctx);
    if (VAPI_OK != vapi_producer_unlock (ctx)) {
      abort (); /* this really shouldn't happen */
    }
...
static void __attribute__((constructor)) __vapi_constructor_one_set_transport_protocol()
{
  ...
  static vapi_message_desc_t __vapi_metadata_one_set_transport_protocol = {
    ...
    (verify_msg_size_fn_t)vapi_verify_one_set_transport_protocol_msg_size,
...
static inline int vapi_verify_one_get_transport_protocol_reply_msg_size(vapi_msg_one_get_transport_protocol_reply *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_get_transport_protocol_reply) > buf_size)
    {
      VAPI_ERR("Truncated 'one_get_transport_protocol_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_get_transport_protocol_reply));
      return -1;
    }
  if (vapi_calc_one_get_transport_protocol_reply_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_get_transport_protocol_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_get_transport_protocol_reply_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_one_get_transport_protocol_reply()
{
  ...
  static vapi_message_desc_t __vapi_metadata_one_get_transport_protocol_reply = {
    ...
    (verify_msg_size_fn_t)vapi_verify_one_get_transport_protocol_reply_msg_size,
...
static inline int vapi_verify_one_get_transport_protocol_msg_size(vapi_msg_one_get_transport_protocol *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_get_transport_protocol) > buf_size)
    {
      VAPI_ERR("Truncated 'one_get_transport_protocol' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_get_transport_protocol));
      return -1;
    }
  if (vapi_calc_one_get_transport_protocol_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_get_transport_protocol' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_get_transport_protocol_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send (ctx, msg))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_one_get_transport_protocol_reply, VAPI_REQUEST_REG, 
                       (vapi_cb_t)reply_callback, reply_callback_ctx);
    if (VAPI_OK != vapi_producer_unlock (ctx)) {
      abort (); /* this really shouldn't happen */
    }
...
static void __attribute__((constructor)) __vapi_constructor_one_get_transport_protocol()
{
  ...
  static vapi_message_desc_t __vapi_metadata_one_get_transport_protocol = {
    ...
    offsetof(vapi_type_msg_header2_t, context),
    VAPI_INVALID_MSG_ID,
    (verify_msg_size_fn_t)vapi_verify_one_get_transport_protocol_msg_size,
...
{
  return sizeof(*msg) + sizeof(msg->payload.bridge_domains[0]) * msg->payload.count;
}

static inline int vapi_verify_one_ndp_bd_get_reply_msg_size(vapi_msg_one_ndp_bd_get_reply *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_ndp_bd_get_reply) > buf_size)
    {
      VAPI_ERR("Truncated 'one_ndp_bd_get_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_ndp_bd_get_reply));
      return -1;
    }
  if (vapi_calc_one_ndp_bd_get_reply_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_ndp_bd_get_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_ndp_bd_get_reply_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_one_ndp_bd_get_reply()
{
  ...
  static vapi_message_desc_t __vapi_metadata_one_ndp_bd_get_reply = {
    ...
    (verify_msg_size_fn_t)vapi_verify_one_ndp_bd_get_reply_msg_size,
...
static inline int vapi_verify_one_ndp_bd_get_msg_size(vapi_msg_one_ndp_bd_get *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_ndp_bd_get) > buf_size)
    {
      VAPI_ERR("Truncated 'one_ndp_bd_get' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_ndp_bd_get));
      return -1;
    }
  if (vapi_calc_one_ndp_bd_get_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_ndp_bd_get' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_ndp_bd_get_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send (ctx, msg))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_one_ndp_bd_get_reply, VAPI_REQUEST_REG, 
                       (vapi_cb_t)reply_callback, reply_callback_ctx);
    if (VAPI_OK != vapi_producer_unlock (ctx)) {
      abort (); /* this really shouldn't happen */
    }
...
static void __attribute__((constructor)) __vapi_constructor_one_ndp_bd_get()
{
  ...
  static vapi_message_desc_t __vapi_metadata_one_ndp_bd_get = {
    ...
    offsetof(vapi_type_msg_header2_t, context),
    VAPI_INVALID_MSG_ID,
    (verify_msg_size_fn_t)vapi_verify_one_ndp_bd_get_msg_size,
...
static inline int vapi_verify_one_l2_arp_bd_get_reply_msg_size(vapi_msg_one_l2_arp_bd_get_reply *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_l2_arp_bd_get_reply) > buf_size)
    {
      VAPI_ERR("Truncated 'one_l2_arp_bd_get_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_l2_arp_bd_get_reply));
      return -1;
    }
  if (vapi_calc_one_l2_arp_bd_get_reply_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_l2_arp_bd_get_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_l2_arp_bd_get_reply_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_one_l2_arp_bd_get_reply()
{
  ...
  static vapi_message_desc_t __vapi_metadata_one_l2_arp_bd_get_reply = {
    ...
    (verify_msg_size_fn_t)vapi_verify_one_l2_arp_bd_get_reply_msg_size,
...
static inline int vapi_verify_one_l2_arp_bd_get_msg_size(vapi_msg_one_l2_arp_bd_get *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_l2_arp_bd_get) > buf_size)
    {
      VAPI_ERR("Truncated 'one_l2_arp_bd_get' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_l2_arp_bd_get));
      return -1;
    }
  if (vapi_calc_one_l2_arp_bd_get_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_l2_arp_bd_get' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_l2_arp_bd_get_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send (ctx, msg))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_one_l2_arp_bd_get_reply, VAPI_REQUEST_REG, 
                       (vapi_cb_t)reply_callback, reply_callback_ctx);
    if (VAPI_OK != vapi_producer_unlock (ctx)) {
      abort (); /* this really shouldn't happen */
    }
...
static void __attribute__((constructor)) __vapi_constructor_one_l2_arp_bd_get()
{
  ...
  static vapi_message_desc_t __vapi_metadata_one_l2_arp_bd_get = {
    ...
    offsetof(vapi_type_msg_header2_t, context),
    VAPI_INVALID_MSG_ID,
    (verify_msg_size_fn_t)vapi_verify_one_l2_arp_bd_get_msg_size,
...
static inline int vapi_verify_one_add_del_adjacency_reply_msg_size(vapi_msg_one_add_del_adjacency_reply *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_add_del_adjacency_reply) > buf_size)
    {
      VAPI_ERR("Truncated 'one_add_del_adjacency_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_add_del_adjacency_reply));
      return -1;
    }
  if (vapi_calc_one_add_del_adjacency_reply_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_add_del_adjacency_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_add_del_adjacency_reply_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_one_add_del_adjacency_reply()
{
  ...
  static vapi_message_desc_t __vapi_metadata_one_add_del_adjacency_reply = {
    ...
    (verify_msg_size_fn_t)vapi_verify_one_add_del_adjacency_reply_msg_size,
...
static inline int vapi_verify_one_add_del_adjacency_msg_size(vapi_msg_one_add_del_adjacency *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_add_del_adjacency) > buf_size)
    {
      VAPI_ERR("Truncated 'one_add_del_adjacency' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_add_del_adjacency));
      return -1;
    }
  if (vapi_calc_one_add_del_adjacency_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_add_del_adjacency' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_add_del_adjacency_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send (ctx, msg))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_one_add_del_adjacency_reply, VAPI_REQUEST_REG, 
                       (vapi_cb_t)reply_callback, reply_callback_ctx);
    if (VAPI_OK != vapi_producer_unlock (ctx)) {
      abort (); /* this really shouldn't happen */
    }
...
static void __attribute__((constructor)) __vapi_constructor_one_add_del_adjacency()
{
  ...
  static const char name_with_crc[] = "one_add_del_adjacency_9e830312";
  static vapi_message_desc_t __vapi_metadata_one_add_del_adjacency = {
    ...
    (verify_msg_size_fn_t)vapi_verify_one_add_del_adjacency_msg_size,
...
static inline int vapi_verify_one_add_del_map_request_itr_rlocs_reply_msg_size(vapi_msg_one_add_del_map_request_itr_rlocs_reply *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_add_del_map_request_itr_rlocs_reply) > buf_size)
    {
      VAPI_ERR("Truncated 'one_add_del_map_request_itr_rlocs_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_add_del_map_request_itr_rlocs_reply));
      return -1;
    }
  if (vapi_calc_one_add_del_map_request_itr_rlocs_reply_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_add_del_map_request_itr_rlocs_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_add_del_map_request_itr_rlocs_reply_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_one_add_del_map_request_itr_rlocs_reply()
{
  ...
  static vapi_message_desc_t __vapi_metadata_one_add_del_map_request_itr_rlocs_reply = {
    ...
    (verify_msg_size_fn_t)vapi_verify_one_add_del_map_request_itr_rlocs_reply_msg_size,
...
static inline int vapi_verify_one_add_del_map_request_itr_rlocs_msg_size(vapi_msg_one_add_del_map_request_itr_rlocs *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_add_del_map_request_itr_rlocs) > buf_size)
    {
      VAPI_ERR("Truncated 'one_add_del_map_request_itr_rlocs' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_add_del_map_request_itr_rlocs));
      return -1;
    }
  if (vapi_calc_one_add_del_map_request_itr_rlocs_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_add_del_map_request_itr_rlocs' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_add_del_map_request_itr_rlocs_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send (ctx, msg))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_one_add_del_map_request_itr_rlocs_reply, VAPI_REQUEST_REG, 
                       (vapi_cb_t)reply_callback, reply_callback_ctx);
    if (VAPI_OK != vapi_producer_unlock (ctx)) {
      abort (); /* this really shouldn't happen */
    }
...
static void __attribute__((constructor)) __vapi_constructor_one_add_del_map_request_itr_rlocs()
{
  ...
  static const char name_with_crc[] = "one_add_del_map_request_itr_rlocs_6be88e45";
  static vapi_message_desc_t __vapi_metadata_one_add_del_map_request_itr_rlocs = {
    ...
    (verify_msg_size_fn_t)vapi_verify_one_add_del_map_request_itr_rlocs_msg_size,
...
static inline int vapi_verify_one_eid_table_add_del_map_reply_msg_size(vapi_msg_one_eid_table_add_del_map_reply *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_eid_table_add_del_map_reply) > buf_size)
    {
      VAPI_ERR("Truncated 'one_eid_table_add_del_map_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_eid_table_add_del_map_reply));
      return -1;
    }
  if (vapi_calc_one_eid_table_add_del_map_reply_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_eid_table_add_del_map_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_eid_table_add_del_map_reply_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_one_eid_table_add_del_map_reply()
{
  ...
  static vapi_message_desc_t __vapi_metadata_one_eid_table_add_del_map_reply = {
    ...
    (verify_msg_size_fn_t)vapi_verify_one_eid_table_add_del_map_reply_msg_size,
...
static inline int vapi_verify_one_eid_table_add_del_map_msg_size(vapi_msg_one_eid_table_add_del_map *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_eid_table_add_del_map) > buf_size)
    {
      VAPI_ERR("Truncated 'one_eid_table_add_del_map' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_eid_table_add_del_map));
      return -1;
    }
  if (vapi_calc_one_eid_table_add_del_map_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_eid_table_add_del_map' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_eid_table_add_del_map_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send (ctx, msg))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_one_eid_table_add_del_map_reply, VAPI_REQUEST_REG, 
                       (vapi_cb_t)reply_callback, reply_callback_ctx);
    if (VAPI_OK != vapi_producer_unlock (ctx)) {
      abort (); /* this really shouldn't happen */
    }
...
static void __attribute__((constructor)) __vapi_constructor_one_eid_table_add_del_map()
{
  ...
  static const char name_with_crc[] = "one_eid_table_add_del_map_9481416b";
  static vapi_message_desc_t __vapi_metadata_one_eid_table_add_del_map = {
    ...
    (verify_msg_size_fn_t)vapi_verify_one_eid_table_add_del_map_msg_size,
...
static inline int vapi_verify_one_locator_details_msg_size(vapi_msg_one_locator_details *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_locator_details) > buf_size)
    {
      VAPI_ERR("Truncated 'one_locator_details' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_locator_details));
      return -1;
    }
  if (vapi_calc_one_locator_details_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_locator_details' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_locator_details_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_one_locator_details()
{
  ...
  static const char name_with_crc[] = "one_locator_details_2c620ffe";
  static vapi_message_desc_t __vapi_metadata_one_locator_details = {
    ...
    (verify_msg_size_fn_t)vapi_verify_one_locator_details_msg_size,
...
static inline int vapi_verify_one_locator_dump_msg_size(vapi_msg_one_locator_dump *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_locator_dump) > buf_size)
    {
      VAPI_ERR("Truncated 'one_locator_dump' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_locator_dump));
      return -1;
    }
  if (vapi_calc_one_locator_dump_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_locator_dump' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_locator_dump_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send_with_control_ping (ctx, msg, req_context))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_one_locator_details, VAPI_REQUEST_DUMP, 
                       (vapi_cb_t)reply_callback, reply_callback_ctx);
    if (VAPI_OK != vapi_producer_unlock (ctx)) {
      abort (); /* this really shouldn't happen */
    }
...
static void __attribute__((constructor)) __vapi_constructor_one_locator_dump()
{
  ...
  static const char name_with_crc[] = "one_locator_dump_9b11076c";
  static vapi_message_desc_t __vapi_metadata_one_locator_dump = {
    ...
    (verify_msg_size_fn_t)vapi_verify_one_locator_dump_msg_size,
...
static inline int vapi_verify_one_locator_set_details_msg_size(vapi_msg_one_locator_set_details *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_locator_set_details) > buf_size)
    {
      VAPI_ERR("Truncated 'one_locator_set_details' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_locator_set_details));
      return -1;
    }
  if (vapi_calc_one_locator_set_details_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_locator_set_details' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_locator_set_details_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_one_locator_set_details()
{
  ...
  static const char name_with_crc[] = "one_locator_set_details_5b33a105";
  static vapi_message_desc_t __vapi_metadata_one_locator_set_details = {
    ...
    (verify_msg_size_fn_t)vapi_verify_one_locator_set_details_msg_size,
...
{
  payload->filter = (vapi_enum_one_filter)htobe32(payload->filter);
}

static inline void vapi_msg_one_locator_set_dump_payload_ntoh(vapi_payload_one_locator_set_dump *payload)
{
  payload->filter = (vapi_enum_one_filter)be32toh(payload->filter);
}
...
static inline int vapi_verify_one_locator_set_dump_msg_size(vapi_msg_one_locator_set_dump *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_locator_set_dump) > buf_size)
    {
      VAPI_ERR("Truncated 'one_locator_set_dump' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_locator_set_dump));
      return -1;
    }
  if (vapi_calc_one_locator_set_dump_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_locator_set_dump' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_locator_set_dump_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send_with_control_ping (ctx, msg, req_context))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_one_locator_set_details, VAPI_REQUEST_DUMP, 
                       (vapi_cb_t)reply_callback, reply_callback_ctx);
    if (VAPI_OK != vapi_producer_unlock (ctx)) {
      abort (); /* this really shouldn't happen */
    }
...
static void __attribute__((constructor)) __vapi_constructor_one_locator_set_dump()
{
  ...
  static const char name_with_crc[] = "one_locator_set_dump_71190768";
  static vapi_message_desc_t __vapi_metadata_one_locator_set_dump = {
    ...
    (verify_msg_size_fn_t)vapi_verify_one_locator_set_dump_msg_size,
...
static inline int vapi_verify_one_eid_table_details_msg_size(vapi_msg_one_eid_table_details *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_eid_table_details) > buf_size)
    {
      VAPI_ERR("Truncated 'one_eid_table_details' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_eid_table_details));
      return -1;
    }
  if (vapi_calc_one_eid_table_details_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_eid_table_details' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_eid_table_details_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_one_eid_table_details()
{
  ...
  static const char name_with_crc[] = "one_eid_table_details_1c29f792";
  static vapi_message_desc_t __vapi_metadata_one_eid_table_details = {
    ...
    (verify_msg_size_fn_t)vapi_verify_one_eid_table_details_msg_size,
...
static inline int vapi_verify_one_eid_table_dump_msg_size(vapi_msg_one_eid_table_dump *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_eid_table_dump) > buf_size)
    {
      VAPI_ERR("Truncated 'one_eid_table_dump' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_eid_table_dump));
      return -1;
    }
  if (vapi_calc_one_eid_table_dump_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_eid_table_dump' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_eid_table_dump_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send_with_control_ping (ctx, msg, req_context))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_one_eid_table_details, VAPI_REQUEST_DUMP, 
                       (vapi_cb_t)reply_callback, reply_callback_ctx);
    if (VAPI_OK != vapi_producer_unlock (ctx)) {
      abort (); /* this really shouldn't happen */
    }
...
static void __attribute__((constructor)) __vapi_constructor_one_eid_table_dump()
{
  ...
  static const char name_with_crc[] = "one_eid_table_dump_bd190269";
  static vapi_message_desc_t __vapi_metadata_one_eid_table_dump = {
    ...
    (verify_msg_size_fn_t)vapi_verify_one_eid_table_dump_msg_size,
...
static inline int vapi_verify_one_adjacencies_get_reply_msg_size(vapi_msg_one_adjacencies_get_reply *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_adjacencies_get_reply) > buf_size)
    {
      VAPI_ERR("Truncated 'one_adjacencies_get_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_adjacencies_get_reply));
      return -1;
    }
  if (vapi_calc_one_adjacencies_get_reply_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_adjacencies_get_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_adjacencies_get_reply_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_one_adjacencies_get_reply()
{
  ...
  static const char name_with_crc[] = "one_adjacencies_get_reply_085bab89";
  static vapi_message_desc_t __vapi_metadata_one_adjacencies_get_reply = {
    ...
    (verify_msg_size_fn_t)vapi_verify_one_adjacencies_get_reply_msg_size,
...
static inline int vapi_verify_one_adjacencies_get_msg_size(vapi_msg_one_adjacencies_get *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_adjacencies_get) > buf_size)
    {
      VAPI_ERR("Truncated 'one_adjacencies_get' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_adjacencies_get));
      return -1;
    }
  if (vapi_calc_one_adjacencies_get_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_adjacencies_get' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_adjacencies_get_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send (ctx, msg))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_one_adjacencies_get_reply, VAPI_REQUEST_REG, 
                       (vapi_cb_t)reply_callback, reply_callback_ctx);
    if (VAPI_OK != vapi_producer_unlock (ctx)) {
      abort (); /* this really shouldn't happen */
    }
...
static void __attribute__((constructor)) __vapi_constructor_one_adjacencies_get()
{
  ...
  static vapi_message_desc_t __vapi_metadata_one_adjacencies_get = {
    ...
    (verify_msg_size_fn_t)vapi_verify_one_adjacencies_get_msg_size,
...
static inline int vapi_verify_one_eid_table_map_details_msg_size(vapi_msg_one_eid_table_map_details *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_eid_table_map_details) > buf_size)
    {
      VAPI_ERR("Truncated 'one_eid_table_map_details' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_eid_table_map_details));
      return -1;
    }
  if (vapi_calc_one_eid_table_map_details_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_eid_table_map_details' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_eid_table_map_details_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_one_eid_table_map_details()
{
  ...
  static vapi_message_desc_t __vapi_metadata_one_eid_table_map_details = {
    ...
    (verify_msg_size_fn_t)vapi_verify_one_eid_table_map_details_msg_size,
...
static inline int vapi_verify_one_eid_table_map_dump_msg_size(vapi_msg_one_eid_table_map_dump *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_eid_table_map_dump) > buf_size)
    {
      VAPI_ERR("Truncated 'one_eid_table_map_dump' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_eid_table_map_dump));
      return -1;
    }
  if (vapi_calc_one_eid_table_map_dump_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_eid_table_map_dump' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_eid_table_map_dump_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send_with_control_ping (ctx, msg, req_context))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_one_eid_table_map_details, VAPI_REQUEST_DUMP, 
                       (vapi_cb_t)reply_callback, reply_callback_ctx);
    if (VAPI_OK != vapi_producer_unlock (ctx)) {
      abort (); /* this really shouldn't happen */
    }
...
static void __attribute__((constructor)) __vapi_constructor_one_eid_table_map_dump()
{
  ...
  static const char name_with_crc[] = "one_eid_table_map_dump_d6cf0c3d";
  static vapi_message_desc_t __vapi_metadata_one_eid_table_map_dump = {
    ...
    (verify_msg_size_fn_t)vapi_verify_one_eid_table_map_dump_msg_size,
...
static inline int vapi_verify_one_eid_table_vni_details_msg_size(vapi_msg_one_eid_table_vni_details *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_eid_table_vni_details) > buf_size)
    {
      VAPI_ERR("Truncated 'one_eid_table_vni_details' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_eid_table_vni_details));
      return -1;
    }
  if (vapi_calc_one_eid_table_vni_details_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_eid_table_vni_details' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_eid_table_vni_details_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_one_eid_table_vni_details()
{
  ...
  static vapi_message_desc_t __vapi_metadata_one_eid_table_vni_details = {
    ...
    (verify_msg_size_fn_t)vapi_verify_one_eid_table_vni_details_msg_size,
...
static inline int vapi_verify_one_eid_table_vni_dump_msg_size(vapi_msg_one_eid_table_vni_dump *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_eid_table_vni_dump) > buf_size)
    {
      VAPI_ERR("Truncated 'one_eid_table_vni_dump' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_eid_table_vni_dump));
      return -1;
    }
  if (vapi_calc_one_eid_table_vni_dump_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_eid_table_vni_dump' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_eid_table_vni_dump_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send_with_control_ping (ctx, msg, req_context))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_one_eid_table_vni_details, VAPI_REQUEST_DUMP, 
                       (vapi_cb_t)reply_callback, reply_callback_ctx);
    if (VAPI_OK != vapi_producer_unlock (ctx)) {
      abort (); /* this really shouldn't happen */
    }
...
static void __attribute__((constructor)) __vapi_constructor_one_eid_table_vni_dump()
{
  ...
  static vapi_message_desc_t __vapi_metadata_one_eid_table_vni_dump = {
    ...
    offsetof(vapi_type_msg_header2_t, context),
    VAPI_INVALID_MSG_ID,
    (verify_msg_size_fn_t)vapi_verify_one_eid_table_vni_dump_msg_size,
...
static inline int vapi_verify_one_map_resolver_details_msg_size(vapi_msg_one_map_resolver_details *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_map_resolver_details) > buf_size)
    {
      VAPI_ERR("Truncated 'one_map_resolver_details' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_map_resolver_details));
      return -1;
    }
  if (vapi_calc_one_map_resolver_details_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_map_resolver_details' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_map_resolver_details_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_one_map_resolver_details()
{
  ...
  static const char name_with_crc[] = "one_map_resolver_details_3e78fc57";
  static vapi_message_desc_t __vapi_metadata_one_map_resolver_details = {
    ...
    (verify_msg_size_fn_t)vapi_verify_one_map_resolver_details_msg_size,
...
static inline int vapi_verify_one_map_resolver_dump_msg_size(vapi_msg_one_map_resolver_dump *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_map_resolver_dump) > buf_size)
    {
      VAPI_ERR("Truncated 'one_map_resolver_dump' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_map_resolver_dump));
      return -1;
    }
  if (vapi_calc_one_map_resolver_dump_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_map_resolver_dump' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_map_resolver_dump_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send_with_control_ping (ctx, msg, req_context))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_one_map_resolver_details, VAPI_REQUEST_DUMP, 
                       (vapi_cb_t)reply_callback, reply_callback_ctx);
    if (VAPI_OK != vapi_producer_unlock (ctx)) {
      abort (); /* this really shouldn't happen */
    }
...
static void __attribute__((constructor)) __vapi_constructor_one_map_resolver_dump()
{
  ...
  static vapi_message_desc_t __vapi_metadata_one_map_resolver_dump = {
    ...
    offsetof(vapi_type_msg_header2_t, context),
    VAPI_INVALID_MSG_ID,
    (verify_msg_size_fn_t)vapi_verify_one_map_resolver_dump_msg_size,
...
static inline int vapi_verify_one_map_server_details_msg_size(vapi_msg_one_map_server_details *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_map_server_details) > buf_size)
    {
      VAPI_ERR("Truncated 'one_map_server_details' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_map_server_details));
      return -1;
    }
  if (vapi_calc_one_map_server_details_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_map_server_details' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_map_server_details_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_one_map_server_details()
{
  ...
  static const char name_with_crc[] = "one_map_server_details_3e78fc57";
  static vapi_message_desc_t __vapi_metadata_one_map_server_details = {
    ...
    (verify_msg_size_fn_t)vapi_verify_one_map_server_details_msg_size,
...
static inline int vapi_verify_one_map_server_dump_msg_size(vapi_msg_one_map_server_dump *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_map_server_dump) > buf_size)
    {
      VAPI_ERR("Truncated 'one_map_server_dump' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_map_server_dump));
      return -1;
    }
  if (vapi_calc_one_map_server_dump_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_map_server_dump' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_map_server_dump_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send_with_control_ping (ctx, msg, req_context))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_one_map_server_details, VAPI_REQUEST_DUMP, 
                       (vapi_cb_t)reply_callback, reply_callback_ctx);
    if (VAPI_OK != vapi_producer_unlock (ctx)) {
      abort (); /* this really shouldn't happen */
    }
...
static void __attribute__((constructor)) __vapi_constructor_one_map_server_dump()
{
  ...
  static vapi_message_desc_t __vapi_metadata_one_map_server_dump = {
    ...
    offsetof(vapi_type_msg_header2_t, context),
    VAPI_INVALID_MSG_ID,
    (verify_msg_size_fn_t)vapi_verify_one_map_server_dump_msg_size,
...
static inline int vapi_verify_show_one_status_reply_msg_size(vapi_msg_show_one_status_reply *msg, uword buf_size)
{
  if (sizeof(vapi_msg_show_one_status_reply) > buf_size)
    {
      VAPI_ERR("Truncated 'show_one_status_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_show_one_status_reply));
      return -1;
    }
  if (vapi_calc_show_one_status_reply_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'show_one_status_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_show_one_status_reply_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_show_one_status_reply()
{
  ...
  static const char name_with_crc[] = "show_one_status_reply_961bb25b";
  static vapi_message_desc_t __vapi_metadata_show_one_status_reply = {
    ...
    (verify_msg_size_fn_t)vapi_verify_show_one_status_reply_msg_size,
...
static inline int vapi_verify_show_one_status_msg_size(vapi_msg_show_one_status *msg, uword buf_size)
{
  if (sizeof(vapi_msg_show_one_status) > buf_size)
    {
      VAPI_ERR("Truncated 'show_one_status' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_show_one_status));
      return -1;
    }
  if (vapi_calc_show_one_status_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'show_one_status' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_show_one_status_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send (ctx, msg))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_show_one_status_reply, VAPI_REQUEST_REG, 
                       (vapi_cb_t)reply_callback, reply_callback_ctx);
    if (VAPI_OK != vapi_producer_unlock (ctx)) {
      abort (); /* this really shouldn't happen */
    }
...
static void __attribute__((constructor)) __vapi_constructor_show_one_status()
{
  ...
  static vapi_message_desc_t __vapi_metadata_show_one_status = {
    ...
    offsetof(vapi_type_msg_header2_t, context),
    VAPI_INVALID_MSG_ID,
    (verify_msg_size_fn_t)vapi_verify_show_one_status_msg_size,
...
static inline int vapi_verify_one_get_map_request_itr_rlocs_reply_msg_size(vapi_msg_one_get_map_request_itr_rlocs_reply *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_get_map_request_itr_rlocs_reply) > buf_size)
    {
      VAPI_ERR("Truncated 'one_get_map_request_itr_rlocs_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_get_map_request_itr_rlocs_reply));
      return -1;
    }
  if (vapi_calc_one_get_map_request_itr_rlocs_reply_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_get_map_request_itr_rlocs_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_get_map_request_itr_rlocs_reply_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_one_get_map_request_itr_rlocs_reply()
{
  ...
  static const char name_with_crc[] = "one_get_map_request_itr_rlocs_reply_76580f3a";
  static vapi_message_desc_t __vapi_metadata_one_get_map_request_itr_rlocs_reply = {
    ...
    (verify_msg_size_fn_t)vapi_verify_one_get_map_request_itr_rlocs_reply_msg_size,
...
static inline int vapi_verify_one_get_map_request_itr_rlocs_msg_size(vapi_msg_one_get_map_request_itr_rlocs *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_get_map_request_itr_rlocs) > buf_size)
    {
      VAPI_ERR("Truncated 'one_get_map_request_itr_rlocs' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_get_map_request_itr_rlocs));
      return -1;
    }
  if (vapi_calc_one_get_map_request_itr_rlocs_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_get_map_request_itr_rlocs' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_get_map_request_itr_rlocs_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send (ctx, msg))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_one_get_map_request_itr_rlocs_reply, VAPI_REQUEST_REG, 
                       (vapi_cb_t)reply_callback, reply_callback_ctx);
    if (VAPI_OK != vapi_producer_unlock (ctx)) {
      abort (); /* this really shouldn't happen */
    }
...
static void __attribute__((constructor)) __vapi_constructor_one_get_map_request_itr_rlocs()
{
  ...
  static vapi_message_desc_t __vapi_metadata_one_get_map_request_itr_rlocs = {
    ...
    offsetof(vapi_type_msg_header2_t, context),
    VAPI_INVALID_MSG_ID,
    (verify_msg_size_fn_t)vapi_verify_one_get_map_request_itr_rlocs_msg_size,
...
static inline int vapi_verify_show_one_nsh_mapping_reply_msg_size(vapi_msg_show_one_nsh_mapping_reply *msg, uword buf_size)
{
  if (sizeof(vapi_msg_show_one_nsh_mapping_reply) > buf_size)
    {
      VAPI_ERR("Truncated 'show_one_nsh_mapping_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_show_one_nsh_mapping_reply));
      return -1;
    }
  if (vapi_calc_show_one_nsh_mapping_reply_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'show_one_nsh_mapping_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_show_one_nsh_mapping_reply_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_show_one_nsh_mapping_reply()
{
  ...
  static const char name_with_crc[] = "show_one_nsh_mapping_reply_46478c02";
  static vapi_message_desc_t __vapi_metadata_show_one_nsh_mapping_reply = {
    ...
    (verify_msg_size_fn_t)vapi_verify_show_one_nsh_mapping_reply_msg_size,
...
static inline int vapi_verify_show_one_nsh_mapping_msg_size(vapi_msg_show_one_nsh_mapping *msg, uword buf_size)
{
  if (sizeof(vapi_msg_show_one_nsh_mapping) > buf_size)
    {
      VAPI_ERR("Truncated 'show_one_nsh_mapping' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_show_one_nsh_mapping));
      return -1;
    }
  if (vapi_calc_show_one_nsh_mapping_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'show_one_nsh_mapping' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_show_one_nsh_mapping_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send (ctx, msg))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_show_one_nsh_mapping_reply, VAPI_REQUEST_REG, 
                       (vapi_cb_t)reply_callback, reply_callback_ctx);
    if (VAPI_OK != vapi_producer_unlock (ctx)) {
      abort (); /* this really shouldn't happen */
    }
...
static void __attribute__((constructor)) __vapi_constructor_show_one_nsh_mapping()
{
  ...
  static vapi_message_desc_t __vapi_metadata_show_one_nsh_mapping = {
    ...
    offsetof(vapi_type_msg_header2_t, context),
    VAPI_INVALID_MSG_ID,
    (verify_msg_size_fn_t)vapi_verify_show_one_nsh_mapping_msg_size,
...
static inline int vapi_verify_show_one_pitr_reply_msg_size(vapi_msg_show_one_pitr_reply *msg, uword buf_size)
{
  if (sizeof(vapi_msg_show_one_pitr_reply) > buf_size)
    {
      VAPI_ERR("Truncated 'show_one_pitr_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_show_one_pitr_reply));
      return -1;
    }
  if (vapi_calc_show_one_pitr_reply_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'show_one_pitr_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_show_one_pitr_reply_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_show_one_pitr_reply()
{
  ...
  static const char name_with_crc[] = "show_one_pitr_reply_a2d1a49f";
  static vapi_message_desc_t __vapi_metadata_show_one_pitr_reply = {
    ...
    (verify_msg_size_fn_t)vapi_verify_show_one_pitr_reply_msg_size,
...
static inline int vapi_verify_show_one_pitr_msg_size(vapi_msg_show_one_pitr *msg, uword buf_size)
{
  if (sizeof(vapi_msg_show_one_pitr) > buf_size)
    {
      VAPI_ERR("Truncated 'show_one_pitr' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_show_one_pitr));
      return -1;
    }
  if (vapi_calc_show_one_pitr_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'show_one_pitr' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_show_one_pitr_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send (ctx, msg))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_show_one_pitr_reply, VAPI_REQUEST_REG, 
                       (vapi_cb_t)reply_callback, reply_callback_ctx);
    if (VAPI_OK != vapi_producer_unlock (ctx)) {
      abort (); /* this really shouldn't happen */
    }
...
static void __attribute__((constructor)) __vapi_constructor_show_one_pitr()
{
  ...
  static vapi_message_desc_t __vapi_metadata_show_one_pitr = {
    ...
    offsetof(vapi_type_msg_header2_t, context),
    VAPI_INVALID_MSG_ID,
    (verify_msg_size_fn_t)vapi_verify_show_one_pitr_msg_size,
...
typedef struct __attribute__ ((__packed__)) {
  ...
  vapi_type_eid deid;
  vapi_type_eid seid;
  vapi_type_address rloc;
  vapi_type_address lloc;
  u32 pkt_count;
  u32 bytes; 
...
static inline int vapi_verify_one_stats_details_msg_size(vapi_msg_one_stats_details *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_stats_details) > buf_size)
    {
      VAPI_ERR("Truncated 'one_stats_details' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_stats_details));
      return -1;
    }
  if (vapi_calc_one_stats_details_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_stats_details' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_stats_details_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_one_stats_details()
{
  ...
  static const char name_with_crc[] = "one_stats_details_2eb74678";
  static vapi_message_desc_t __vapi_metadata_one_stats_details = {
    ...
    (verify_msg_size_fn_t)vapi_verify_one_stats_details_msg_size,
...
static inline int vapi_verify_one_stats_dump_msg_size(vapi_msg_one_stats_dump *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_stats_dump) > buf_size)
    {
      VAPI_ERR("Truncated 'one_stats_dump' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_stats_dump));
      return -1;
    }
  if (vapi_calc_one_stats_dump_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_stats_dump' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_stats_dump_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send_with_control_ping (ctx, msg, req_context))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_one_stats_details, VAPI_REQUEST_DUMP, 
                       (vapi_cb_t)reply_callback, reply_callback_ctx);
    if (VAPI_OK != vapi_producer_unlock (ctx)) {
      abort (); /* this really shouldn't happen */
    }
...
static void __attribute__((constructor)) __vapi_constructor_one_stats_dump()
{
  ...
  static vapi_message_desc_t __vapi_metadata_one_stats_dump = {
    ...
    offsetof(vapi_type_msg_header2_t, context),
    VAPI_INVALID_MSG_ID,
    (verify_msg_size_fn_t)vapi_verify_one_stats_dump_msg_size,
...
static inline int vapi_verify_one_stats_flush_reply_msg_size(vapi_msg_one_stats_flush_reply *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_stats_flush_reply) > buf_size)
    {
      VAPI_ERR("Truncated 'one_stats_flush_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_stats_flush_reply));
      return -1;
    }
  if (vapi_calc_one_stats_flush_reply_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_stats_flush_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_stats_flush_reply_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_one_stats_flush_reply()
{
  ...
  static vapi_message_desc_t __vapi_metadata_one_stats_flush_reply = {
    ...
    (verify_msg_size_fn_t)vapi_verify_one_stats_flush_reply_msg_size,
...
static inline int vapi_verify_one_stats_flush_msg_size(vapi_msg_one_stats_flush *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_stats_flush) > buf_size)
    {
      VAPI_ERR("Truncated 'one_stats_flush' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_stats_flush));
      return -1;
    }
  if (vapi_calc_one_stats_flush_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_stats_flush' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_stats_flush_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send (ctx, msg))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_one_stats_flush_reply, VAPI_REQUEST_REG, 
                       (vapi_cb_t)reply_callback, reply_callback_ctx);
    if (VAPI_OK != vapi_producer_unlock (ctx)) {
      abort (); /* this really shouldn't happen */
    }
...
static void __attribute__((constructor)) __vapi_constructor_one_stats_flush()
{
  ...
  static vapi_message_desc_t __vapi_metadata_one_stats_flush = {
    ...
    offsetof(vapi_type_msg_header2_t, context),
    VAPI_INVALID_MSG_ID,
    (verify_msg_size_fn_t)vapi_verify_one_stats_flush_msg_size,
...
static inline int vapi_verify_one_stats_enable_disable_reply_msg_size(vapi_msg_one_stats_enable_disable_reply *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_stats_enable_disable_reply) > buf_size)
    {
      VAPI_ERR("Truncated 'one_stats_enable_disable_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_stats_enable_disable_reply));
      return -1;
    }
  if (vapi_calc_one_stats_enable_disable_reply_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_stats_enable_disable_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_stats_enable_disable_reply_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_one_stats_enable_disable_reply()
{
  ...
  static vapi_message_desc_t __vapi_metadata_one_stats_enable_disable_reply = {
    ...
    (verify_msg_size_fn_t)vapi_verify_one_stats_enable_disable_reply_msg_size,
...
static inline int vapi_verify_one_stats_enable_disable_msg_size(vapi_msg_one_stats_enable_disable *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_stats_enable_disable) > buf_size)
    {
      VAPI_ERR("Truncated 'one_stats_enable_disable' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_stats_enable_disable));
      return -1;
    }
  if (vapi_calc_one_stats_enable_disable_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_stats_enable_disable' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_stats_enable_disable_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send (ctx, msg))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_one_stats_enable_disable_reply, VAPI_REQUEST_REG, 
                       (vapi_cb_t)reply_callback, reply_callback_ctx);
    if (VAPI_OK != vapi_producer_unlock (ctx)) {
      abort (); /* this really shouldn't happen */
    }
...
static void __attribute__((constructor)) __vapi_constructor_one_stats_enable_disable()
{
  ...
  static const char name_with_crc[] = "one_stats_enable_disable_c264d7bf";
  static vapi_message_desc_t __vapi_metadata_one_stats_enable_disable = {
    ...
    (verify_msg_size_fn_t)vapi_verify_one_stats_enable_disable_msg_size,
...
static inline int vapi_verify_show_one_stats_enable_disable_reply_msg_size(vapi_msg_show_one_stats_enable_disable_reply *msg, uword buf_size)
{
  if (sizeof(vapi_msg_show_one_stats_enable_disable_reply) > buf_size)
    {
      VAPI_ERR("Truncated 'show_one_stats_enable_disable_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_show_one_stats_enable_disable_reply));
      return -1;
    }
  if (vapi_calc_show_one_stats_enable_disable_reply_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'show_one_stats_enable_disable_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_show_one_stats_enable_disable_reply_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_show_one_stats_enable_disable_reply()
{
  ...
  static const char name_with_crc[] = "show_one_stats_enable_disable_reply_f15abb16";
  static vapi_message_desc_t __vapi_metadata_show_one_stats_enable_disable_reply = {
    ...
    (verify_msg_size_fn_t)vapi_verify_show_one_stats_enable_disable_reply_msg_size,
...
static inline int vapi_verify_show_one_stats_enable_disable_msg_size(vapi_msg_show_one_stats_enable_disable *msg, uword buf_size)
{
  if (sizeof(vapi_msg_show_one_stats_enable_disable) > buf_size)
    {
      VAPI_ERR("Truncated 'show_one_stats_enable_disable' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_show_one_stats_enable_disable));
      return -1;
    }
  if (vapi_calc_show_one_stats_enable_disable_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'show_one_stats_enable_disable' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_show_one_stats_enable_disable_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send (ctx, msg))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_show_one_stats_enable_disable_reply, VAPI_REQUEST_REG, 
                       (vapi_cb_t)reply_callback, reply_callback_ctx);
    if (VAPI_OK != vapi_producer_unlock (ctx)) {
      abort (); /* this really shouldn't happen */
    }
...
static void __attribute__((constructor)) __vapi_constructor_show_one_stats_enable_disable()
{
  ...
  static vapi_message_desc_t __vapi_metadata_show_one_stats_enable_disable = {
    ...
    offsetof(vapi_type_msg_header2_t, context),
    VAPI_INVALID_MSG_ID,
    (verify_msg_size_fn_t)vapi_verify_show_one_stats_enable_disable_msg_size,
...
static inline int vapi_verify_one_map_register_fallback_threshold_reply_msg_size(vapi_msg_one_map_register_fallback_threshold_reply *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_map_register_fallback_threshold_reply) > buf_size)
    {
      VAPI_ERR("Truncated 'one_map_register_fallback_threshold_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_map_register_fallback_threshold_reply));
      return -1;
    }
  if (vapi_calc_one_map_register_fallback_threshold_reply_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_map_register_fallback_threshold_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_map_register_fallback_threshold_reply_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_one_map_register_fallback_threshold_reply()
{
  ...
  static vapi_message_desc_t __vapi_metadata_one_map_register_fallback_threshold_reply = {
    ...
    (verify_msg_size_fn_t)vapi_verify_one_map_register_fallback_threshold_reply_msg_size,
...
static inline int vapi_verify_one_map_register_fallback_threshold_msg_size(vapi_msg_one_map_register_fallback_threshold *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_map_register_fallback_threshold) > buf_size)
    {
      VAPI_ERR("Truncated 'one_map_register_fallback_threshold' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_map_register_fallback_threshold));
      return -1;
    }
  if (vapi_calc_one_map_register_fallback_threshold_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_map_register_fallback_threshold' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_map_register_fallback_threshold_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send (ctx, msg))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_one_map_register_fallback_threshold_reply, VAPI_REQUEST_REG, 
                       (vapi_cb_t)reply_callback, reply_callback_ctx);
    if (VAPI_OK != vapi_producer_unlock (ctx)) {
      abort (); /* this really shouldn't happen */
    }
...
static void __attribute__((constructor)) __vapi_constructor_one_map_register_fallback_threshold()
{
  ...
  static vapi_message_desc_t __vapi_metadata_one_map_register_fallback_threshold = {
    ...
    (verify_msg_size_fn_t)vapi_verify_one_map_register_fallback_threshold_msg_size,
...
static inline int vapi_verify_show_one_map_register_fallback_threshold_reply_msg_size(vapi_msg_show_one_map_register_fallback_threshold_reply *msg, uword buf_size)
{
  if (sizeof(vapi_msg_show_one_map_register_fallback_threshold_reply) > buf_size)
    {
      VAPI_ERR("Truncated 'show_one_map_register_fallback_threshold_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_show_one_map_register_fallback_threshold_reply));
      return -1;
    }
  if (vapi_calc_show_one_map_register_fallback_threshold_reply_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'show_one_map_register_fallback_threshold_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_show_one_map_register_fallback_threshold_reply_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_show_one_map_register_fallback_threshold_reply()
{
  ...
  static vapi_message_desc_t __vapi_metadata_show_one_map_register_fallback_threshold_reply = {
    ...
    (verify_msg_size_fn_t)vapi_verify_show_one_map_register_fallback_threshold_reply_msg_size,
...
static inline int vapi_verify_show_one_map_register_fallback_threshold_msg_size(vapi_msg_show_one_map_register_fallback_threshold *msg, uword buf_size)
{
  if (sizeof(vapi_msg_show_one_map_register_fallback_threshold) > buf_size)
    {
      VAPI_ERR("Truncated 'show_one_map_register_fallback_threshold' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_show_one_map_register_fallback_threshold));
      return -1;
    }
  if (vapi_calc_show_one_map_register_fallback_threshold_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'show_one_map_register_fallback_threshold' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_show_one_map_register_fallback_threshold_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send (ctx, msg))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_show_one_map_register_fallback_threshold_reply, VAPI_REQUEST_REG, 
                       (vapi_cb_t)reply_callback, reply_callback_ctx);
    if (VAPI_OK != vapi_producer_unlock (ctx)) {
      abort (); /* this really shouldn't happen */
    }
...
static void __attribute__((constructor)) __vapi_constructor_show_one_map_register_fallback_threshold()
{
  ...
  static vapi_message_desc_t __vapi_metadata_show_one_map_register_fallback_threshold = {
    ...
    offsetof(vapi_type_msg_header2_t, context),
    VAPI_INVALID_MSG_ID,
    (verify_msg_size_fn_t)vapi_verify_show_one_map_register_fallback_threshold_msg_size,
...
static inline int vapi_verify_one_enable_disable_xtr_mode_reply_msg_size(vapi_msg_one_enable_disable_xtr_mode_reply *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_enable_disable_xtr_mode_reply) > buf_size)
    {
      VAPI_ERR("Truncated 'one_enable_disable_xtr_mode_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_enable_disable_xtr_mode_reply));
      return -1;
    }
  if (vapi_calc_one_enable_disable_xtr_mode_reply_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_enable_disable_xtr_mode_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_enable_disable_xtr_mode_reply_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_one_enable_disable_xtr_mode_reply()
{
  ...
  static vapi_message_desc_t __vapi_metadata_one_enable_disable_xtr_mode_reply = {
    ...
    (verify_msg_size_fn_t)vapi_verify_one_enable_disable_xtr_mode_reply_msg_size,
...
static inline int vapi_verify_one_enable_disable_xtr_mode_msg_size(vapi_msg_one_enable_disable_xtr_mode *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_enable_disable_xtr_mode) > buf_size)
    {
      VAPI_ERR("Truncated 'one_enable_disable_xtr_mode' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_enable_disable_xtr_mode));
      return -1;
    }
  if (vapi_calc_one_enable_disable_xtr_mode_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_enable_disable_xtr_mode' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_enable_disable_xtr_mode_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send (ctx, msg))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_one_enable_disable_xtr_mode_reply, VAPI_REQUEST_REG, 
                       (vapi_cb_t)reply_callback, reply_callback_ctx);
    if (VAPI_OK != vapi_producer_unlock (ctx)) {
      abort (); /* this really shouldn't happen */
    }
...
static void __attribute__((constructor)) __vapi_constructor_one_enable_disable_xtr_mode()
{
  ...
  static const char name_with_crc[] = "one_enable_disable_xtr_mode_c264d7bf";
  static vapi_message_desc_t __vapi_metadata_one_enable_disable_xtr_mode = {
    ...
    (verify_msg_size_fn_t)vapi_verify_one_enable_disable_xtr_mode_msg_size,
...
static inline int vapi_verify_one_show_xtr_mode_reply_msg_size(vapi_msg_one_show_xtr_mode_reply *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_show_xtr_mode_reply) > buf_size)
    {
      VAPI_ERR("Truncated 'one_show_xtr_mode_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_show_xtr_mode_reply));
      return -1;
    }
  if (vapi_calc_one_show_xtr_mode_reply_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_show_xtr_mode_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_show_xtr_mode_reply_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_one_show_xtr_mode_reply()
{
  ...
  static const char name_with_crc[] = "one_show_xtr_mode_reply_f15abb16";
  static vapi_message_desc_t __vapi_metadata_one_show_xtr_mode_reply = {
    ...
    (verify_msg_size_fn_t)vapi_verify_one_show_xtr_mode_reply_msg_size,
...
static inline int vapi_verify_one_show_xtr_mode_msg_size(vapi_msg_one_show_xtr_mode *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_show_xtr_mode) > buf_size)
    {
      VAPI_ERR("Truncated 'one_show_xtr_mode' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_show_xtr_mode));
      return -1;
    }
  if (vapi_calc_one_show_xtr_mode_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_show_xtr_mode' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_show_xtr_mode_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send (ctx, msg))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_one_show_xtr_mode_reply, VAPI_REQUEST_REG, 
                       (vapi_cb_t)reply_callback, reply_callback_ctx);
    if (VAPI_OK != vapi_producer_unlock (ctx)) {
      abort (); /* this really shouldn't happen */
    }
...
static void __attribute__((constructor)) __vapi_constructor_one_show_xtr_mode()
{
  ...
  static vapi_message_desc_t __vapi_metadata_one_show_xtr_mode = {
    ...
    offsetof(vapi_type_msg_header2_t, context),
    VAPI_INVALID_MSG_ID,
    (verify_msg_size_fn_t)vapi_verify_one_show_xtr_mode_msg_size,
...
static inline int vapi_verify_one_enable_disable_petr_mode_reply_msg_size(vapi_msg_one_enable_disable_petr_mode_reply *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_enable_disable_petr_mode_reply) > buf_size)
    {
      VAPI_ERR("Truncated 'one_enable_disable_petr_mode_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_enable_disable_petr_mode_reply));
      return -1;
    }
  if (vapi_calc_one_enable_disable_petr_mode_reply_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_enable_disable_petr_mode_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_enable_disable_petr_mode_reply_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_one_enable_disable_petr_mode_reply()
{
  ...
  static vapi_message_desc_t __vapi_metadata_one_enable_disable_petr_mode_reply = {
    ...
    (verify_msg_size_fn_t)vapi_verify_one_enable_disable_petr_mode_reply_msg_size,
...
static inline int vapi_verify_one_enable_disable_petr_mode_msg_size(vapi_msg_one_enable_disable_petr_mode *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_enable_disable_petr_mode) > buf_size)
    {
      VAPI_ERR("Truncated 'one_enable_disable_petr_mode' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_enable_disable_petr_mode));
      return -1;
    }
  if (vapi_calc_one_enable_disable_petr_mode_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_enable_disable_petr_mode' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_enable_disable_petr_mode_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send (ctx, msg))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_one_enable_disable_petr_mode_reply, VAPI_REQUEST_REG, 
                       (vapi_cb_t)reply_callback, reply_callback_ctx);
    if (VAPI_OK != vapi_producer_unlock (ctx)) {
      abort (); /* this really shouldn't happen */
    }
...
static void __attribute__((constructor)) __vapi_constructor_one_enable_disable_petr_mode()
{
  ...
  static const char name_with_crc[] = "one_enable_disable_petr_mode_c264d7bf";
  static vapi_message_desc_t __vapi_metadata_one_enable_disable_petr_mode = {
    ...
    (verify_msg_size_fn_t)vapi_verify_one_enable_disable_petr_mode_msg_size,
...
static inline int vapi_verify_one_show_petr_mode_reply_msg_size(vapi_msg_one_show_petr_mode_reply *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_show_petr_mode_reply) > buf_size)
    {
      VAPI_ERR("Truncated 'one_show_petr_mode_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_show_petr_mode_reply));
      return -1;
    }
  if (vapi_calc_one_show_petr_mode_reply_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_show_petr_mode_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_show_petr_mode_reply_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_one_show_petr_mode_reply()
{
  ...
  static const char name_with_crc[] = "one_show_petr_mode_reply_f15abb16";
  static vapi_message_desc_t __vapi_metadata_one_show_petr_mode_reply = {
    ...
    (verify_msg_size_fn_t)vapi_verify_one_show_petr_mode_reply_msg_size,
...
static inline int vapi_verify_one_show_petr_mode_msg_size(vapi_msg_one_show_petr_mode *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_show_petr_mode) > buf_size)
    {
      VAPI_ERR("Truncated 'one_show_petr_mode' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_show_petr_mode));
      return -1;
    }
  if (vapi_calc_one_show_petr_mode_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_show_petr_mode' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_show_petr_mode_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send (ctx, msg))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_one_show_petr_mode_reply, VAPI_REQUEST_REG, 
                       (vapi_cb_t)reply_callback, reply_callback_ctx);
    if (VAPI_OK != vapi_producer_unlock (ctx)) {
      abort (); /* this really shouldn't happen */
    }
...
static void __attribute__((constructor)) __vapi_constructor_one_show_petr_mode()
{
  ...
  static vapi_message_desc_t __vapi_metadata_one_show_petr_mode = {
    ...
    offsetof(vapi_type_msg_header2_t, context),
    VAPI_INVALID_MSG_ID,
    (verify_msg_size_fn_t)vapi_verify_one_show_petr_mode_msg_size,
...
static inline int vapi_verify_one_enable_disable_pitr_mode_reply_msg_size(vapi_msg_one_enable_disable_pitr_mode_reply *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_enable_disable_pitr_mode_reply) > buf_size)
    {
      VAPI_ERR("Truncated 'one_enable_disable_pitr_mode_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_enable_disable_pitr_mode_reply));
      return -1;
    }
  if (vapi_calc_one_enable_disable_pitr_mode_reply_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_enable_disable_pitr_mode_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_enable_disable_pitr_mode_reply_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_one_enable_disable_pitr_mode_reply()
{
  ...
  static vapi_message_desc_t __vapi_metadata_one_enable_disable_pitr_mode_reply = {
    ...
    (verify_msg_size_fn_t)vapi_verify_one_enable_disable_pitr_mode_reply_msg_size,
...
static inline int vapi_verify_one_enable_disable_pitr_mode_msg_size(vapi_msg_one_enable_disable_pitr_mode *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_enable_disable_pitr_mode) > buf_size)
    {
      VAPI_ERR("Truncated 'one_enable_disable_pitr_mode' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_enable_disable_pitr_mode));
      return -1;
    }
  if (vapi_calc_one_enable_disable_pitr_mode_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_enable_disable_pitr_mode' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_enable_disable_pitr_mode_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send (ctx, msg))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_one_enable_disable_pitr_mode_reply, VAPI_REQUEST_REG, 
                       (vapi_cb_t)reply_callback, reply_callback_ctx);
    if (VAPI_OK != vapi_producer_unlock (ctx)) {
      abort (); /* this really shouldn't happen */
    }
...
static void __attribute__((constructor)) __vapi_constructor_one_enable_disable_pitr_mode()
{
  ...
  static const char name_with_crc[] = "one_enable_disable_pitr_mode_c264d7bf";
  static vapi_message_desc_t __vapi_metadata_one_enable_disable_pitr_mode = {
    ...
    (verify_msg_size_fn_t)vapi_verify_one_enable_disable_pitr_mode_msg_size,
...
static inline int vapi_verify_one_show_pitr_mode_reply_msg_size(vapi_msg_one_show_pitr_mode_reply *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_show_pitr_mode_reply) > buf_size)
    {
      VAPI_ERR("Truncated 'one_show_pitr_mode_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_show_pitr_mode_reply));
      return -1;
    }
  if (vapi_calc_one_show_pitr_mode_reply_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_show_pitr_mode_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_show_pitr_mode_reply_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_one_show_pitr_mode_reply()
{
  ...
  static const char name_with_crc[] = "one_show_pitr_mode_reply_f15abb16";
  static vapi_message_desc_t __vapi_metadata_one_show_pitr_mode_reply = {
    ...
    (verify_msg_size_fn_t)vapi_verify_one_show_pitr_mode_reply_msg_size,
...
static inline int vapi_verify_one_show_pitr_mode_msg_size(vapi_msg_one_show_pitr_mode *msg, uword buf_size)
{
  if (sizeof(vapi_msg_one_show_pitr_mode) > buf_size)
    {
      VAPI_ERR("Truncated 'one_show_pitr_mode' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_one_show_pitr_mode));
      return -1;
    }
  if (vapi_calc_one_show_pitr_mode_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'one_show_pitr_mode' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_one_show_pitr_mode_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send (ctx, msg))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_one_show_pitr_mode_reply, VAPI_REQUEST_REG, 
                       (vapi_cb_t)reply_callback, reply_callback_ctx);
    if (VAPI_OK != vapi_producer_unlock (ctx)) {
      abort (); /* this really shouldn't happen */
    }
...
static void __attribute__((constructor)) __vapi_constructor_one_show_pitr_mode()
{
  ...
  static vapi_message_desc_t __vapi_metadata_one_show_pitr_mode = {
    ...
    offsetof(vapi_type_msg_header2_t, context),
    VAPI_INVALID_MSG_ID,
    (verify_msg_size_fn_t)vapi_verify_one_show_pitr_mode_msg_size,
