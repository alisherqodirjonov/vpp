#ifndef __included_udp_api_json
#define __included_udp_api_json
...
extern vapi_msg_id_t vapi_msg_id_udp_decap_add_del;
extern vapi_msg_id_t vapi_msg_id_udp_decap_add_del_reply;
...
#define DEFINE_VAPI_MSG_IDS_UDP_API_JSON\
  ...
  vapi_msg_id_t vapi_msg_id_udp_decap_add_del;\
  vapi_msg_id_t vapi_msg_id_udp_decap_add_del_reply;
...
#ifndef defined_vapi_enum_udp_decap_next_proto
#define defined_vapi_enum_udp_decap_next_proto
typedef enum {
  UDP_API_DECAP_PROTO_IP4 = 0,
  UDP_API_DECAP_PROTO_IP6 = 1,
  UDP_API_DECAP_PROTO_MPLS = 2,
}  vapi_enum_udp_decap_next_proto;
...
#ifndef defined_vapi_type_udp_decap
#define defined_vapi_type_udp_decap
typedef struct __attribute__((__packed__)) {
  u8 is_ip4;
  u16 port;
  vapi_enum_udp_decap_next_proto next_proto;
} vapi_type_udp_decap;

static inline void vapi_type_udp_decap_hton(vapi_type_udp_decap *msg)
{
  msg->port = htobe16(msg->port);
  msg->next_proto = (vapi_enum_udp_decap_next_proto)htobe32(msg->next_proto);
}

static inline void vapi_type_udp_decap_ntoh(vapi_type_udp_decap *msg)
{
  msg->port = be16toh(msg->port);
  msg->next_proto = (vapi_enum_udp_decap_next_proto)be32toh(msg->next_proto);
}
#endif
...
static inline int vapi_verify_udp_encap_add_reply_msg_size(vapi_msg_udp_encap_add_reply *msg, uword buf_size)
{
  if (sizeof(vapi_msg_udp_encap_add_reply) > buf_size)
    {
      VAPI_ERR("Truncated 'udp_encap_add_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_udp_encap_add_reply));
      return -1;
    }
  if (vapi_calc_udp_encap_add_reply_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'udp_encap_add_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_udp_encap_add_reply_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_udp_encap_add_reply()
{
  ...
  static vapi_message_desc_t __vapi_metadata_udp_encap_add_reply = {
    ...
    (verify_msg_size_fn_t)vapi_verify_udp_encap_add_reply_msg_size,
...
static inline int vapi_verify_udp_encap_add_msg_size(vapi_msg_udp_encap_add *msg, uword buf_size)
{
  if (sizeof(vapi_msg_udp_encap_add) > buf_size)
    {
      VAPI_ERR("Truncated 'udp_encap_add' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_udp_encap_add));
      return -1;
    }
  if (vapi_calc_udp_encap_add_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'udp_encap_add' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_udp_encap_add_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send (ctx, msg))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_udp_encap_add_reply, VAPI_REQUEST_REG, 
...
static void __attribute__((constructor)) __vapi_constructor_udp_encap_add()
{
  ...
  static const char name_with_crc[] = "udp_encap_add_f74a60b1";
  static vapi_message_desc_t __vapi_metadata_udp_encap_add = {
    ...
    (verify_msg_size_fn_t)vapi_verify_udp_encap_add_msg_size,
...
static inline int vapi_verify_udp_encap_del_reply_msg_size(vapi_msg_udp_encap_del_reply *msg, uword buf_size)
{
  if (sizeof(vapi_msg_udp_encap_del_reply) > buf_size)
    {
      VAPI_ERR("Truncated 'udp_encap_del_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_udp_encap_del_reply));
      return -1;
    }
  if (vapi_calc_udp_encap_del_reply_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'udp_encap_del_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_udp_encap_del_reply_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_udp_encap_del_reply()
{
  ...
  static vapi_message_desc_t __vapi_metadata_udp_encap_del_reply = {
    ...
    (verify_msg_size_fn_t)vapi_verify_udp_encap_del_reply_msg_size,
...
static inline int vapi_verify_udp_encap_del_msg_size(vapi_msg_udp_encap_del *msg, uword buf_size)
{
  if (sizeof(vapi_msg_udp_encap_del) > buf_size)
    {
      VAPI_ERR("Truncated 'udp_encap_del' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_udp_encap_del));
      return -1;
    }
  if (vapi_calc_udp_encap_del_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'udp_encap_del' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_udp_encap_del_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send (ctx, msg))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_udp_encap_del_reply, VAPI_REQUEST_REG, 
                       (vapi_cb_t)reply_callback, reply_callback_ctx);
    if (VAPI_OK != vapi_producer_unlock (ctx)) {
      abort (); /* this really shouldn't happen */
    }
...
static void __attribute__((constructor)) __vapi_constructor_udp_encap_del()
{
  ...
  static vapi_message_desc_t __vapi_metadata_udp_encap_del = {
    ...
    (verify_msg_size_fn_t)vapi_verify_udp_encap_del_msg_size,
...
static inline int vapi_verify_udp_encap_details_msg_size(vapi_msg_udp_encap_details *msg, uword buf_size)
{
  if (sizeof(vapi_msg_udp_encap_details) > buf_size)
    {
      VAPI_ERR("Truncated 'udp_encap_details' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_udp_encap_details));
      return -1;
    }
  if (vapi_calc_udp_encap_details_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'udp_encap_details' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_udp_encap_details_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_udp_encap_details()
{
  ...
  static const char name_with_crc[] = "udp_encap_details_8cfb9c76";
  static vapi_message_desc_t __vapi_metadata_udp_encap_details = {
    ...
    (verify_msg_size_fn_t)vapi_verify_udp_encap_details_msg_size,
...
static inline int vapi_verify_udp_encap_dump_msg_size(vapi_msg_udp_encap_dump *msg, uword buf_size)
{
  if (sizeof(vapi_msg_udp_encap_dump) > buf_size)
    {
      VAPI_ERR("Truncated 'udp_encap_dump' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_udp_encap_dump));
      return -1;
    }
  if (vapi_calc_udp_encap_dump_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'udp_encap_dump' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_udp_encap_dump_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send_with_control_ping (ctx, msg, req_context))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_udp_encap_details, VAPI_REQUEST_DUMP, 
                       (vapi_cb_t)reply_callback, reply_callback_ctx);
    if (VAPI_OK != vapi_producer_unlock (ctx)) {
      abort (); /* this really shouldn't happen */
    }
...
static void __attribute__((constructor)) __vapi_constructor_udp_encap_dump()
{
  ...
  static vapi_message_desc_t __vapi_metadata_udp_encap_dump = {
    ...
    offsetof(vapi_type_msg_header2_t, context),
    VAPI_INVALID_MSG_ID,
    (verify_msg_size_fn_t)vapi_verify_udp_encap_dump_msg_size,
...
#ifndef defined_vapi_msg_udp_decap_add_del_reply
#define defined_vapi_msg_udp_decap_add_del_reply
typedef struct __attribute__ ((__packed__)) {
  i32 retval; 
} vapi_payload_udp_decap_add_del_reply;

typedef struct __attribute__ ((__packed__)) {
  vapi_type_msg_header1_t header;
  vapi_payload_udp_decap_add_del_reply payload;
} vapi_msg_udp_decap_add_del_reply;

static inline void vapi_msg_udp_decap_add_del_reply_payload_hton(vapi_payload_udp_decap_add_del_reply *payload)
{
  payload->retval = htobe32(payload->retval);
}

static inline void vapi_msg_udp_decap_add_del_reply_payload_ntoh(vapi_payload_udp_decap_add_del_reply *payload)
{
  payload->retval = be32toh(payload->retval);
}

static inline void vapi_msg_udp_decap_add_del_reply_hton(vapi_msg_udp_decap_add_del_reply *msg)
{
  VAPI_DBG("Swapping `vapi_msg_udp_decap_add_del_reply'@%p to big endian", msg);
  vapi_type_msg_header1_t_hton(&msg->header);
  vapi_msg_udp_decap_add_del_reply_payload_hton(&msg->payload);
}

static inline void vapi_msg_udp_decap_add_del_reply_ntoh(vapi_msg_udp_decap_add_del_reply *msg)
{
  VAPI_DBG("Swapping `vapi_msg_udp_decap_add_del_reply'@%p to host byte order", msg);
  vapi_type_msg_header1_t_ntoh(&msg->header);
  vapi_msg_udp_decap_add_del_reply_payload_ntoh(&msg->payload);
}

static inline uword vapi_calc_udp_decap_add_del_reply_msg_size(vapi_msg_udp_decap_add_del_reply *msg)
{
  return sizeof(*msg);
}

static inline int vapi_verify_udp_decap_add_del_reply_msg_size(vapi_msg_udp_decap_add_del_reply *msg, uword buf_size)
{
  if (sizeof(vapi_msg_udp_decap_add_del_reply) > buf_size)
    {
      VAPI_ERR("Truncated 'udp_decap_add_del_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_udp_decap_add_del_reply));
      return -1;
    }
  if (vapi_calc_udp_decap_add_del_reply_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'udp_decap_add_del_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_udp_decap_add_del_reply_msg_size(msg));
      return -1;
    }
  return 0;
}

static void __attribute__((constructor)) __vapi_constructor_udp_decap_add_del_reply()
{
  static const char name[] = "udp_decap_add_del_reply";
  static const char name_with_crc[] = "udp_decap_add_del_reply_e8d4e804";
  static vapi_message_desc_t __vapi_metadata_udp_decap_add_del_reply = {
    name,
    sizeof(name) - 1,
    name_with_crc,
    sizeof(name_with_crc) - 1,
    true,
    offsetof(vapi_type_msg_header1_t, context),
    offsetof(vapi_msg_udp_decap_add_del_reply, payload),
    (verify_msg_size_fn_t)vapi_verify_udp_decap_add_del_reply_msg_size,
    (generic_swap_fn_t)vapi_msg_udp_decap_add_del_reply_hton,
    (generic_swap_fn_t)vapi_msg_udp_decap_add_del_reply_ntoh,
    VAPI_INVALID_MSG_ID,
  };

  vapi_msg_id_udp_decap_add_del_reply = vapi_register_msg(&__vapi_metadata_udp_decap_add_del_reply);
  VAPI_DBG("Assigned msg id %d to udp_decap_add_del_reply", vapi_msg_id_udp_decap_add_del_reply);
}

static inline void vapi_set_vapi_msg_udp_decap_add_del_reply_event_cb (
  struct vapi_ctx_s *ctx, 
  vapi_error_e (*callback)(struct vapi_ctx_s *ctx, void *callback_ctx, vapi_payload_udp_decap_add_del_reply *payload),
  void *callback_ctx)
{
  vapi_set_event_cb(ctx, vapi_msg_id_udp_decap_add_del_reply, (vapi_event_cb)callback, callback_ctx);
};
#endif

#ifndef defined_vapi_msg_udp_decap_add_del
#define defined_vapi_msg_udp_decap_add_del
typedef struct __attribute__ ((__packed__)) {
  bool is_add;
  vapi_type_udp_decap udp_decap; 
} vapi_payload_udp_decap_add_del;

typedef struct __attribute__ ((__packed__)) {
  vapi_type_msg_header2_t header;
  vapi_payload_udp_decap_add_del payload;
} vapi_msg_udp_decap_add_del;

static inline void vapi_msg_udp_decap_add_del_payload_hton(vapi_payload_udp_decap_add_del *payload)
{
  vapi_type_udp_decap_hton(&payload->udp_decap);
}

static inline void vapi_msg_udp_decap_add_del_payload_ntoh(vapi_payload_udp_decap_add_del *payload)
{
  vapi_type_udp_decap_ntoh(&payload->udp_decap);
}

static inline void vapi_msg_udp_decap_add_del_hton(vapi_msg_udp_decap_add_del *msg)
{
  VAPI_DBG("Swapping `vapi_msg_udp_decap_add_del'@%p to big endian", msg);
  vapi_type_msg_header2_t_hton(&msg->header);
  vapi_msg_udp_decap_add_del_payload_hton(&msg->payload);
}

static inline void vapi_msg_udp_decap_add_del_ntoh(vapi_msg_udp_decap_add_del *msg)
{
  VAPI_DBG("Swapping `vapi_msg_udp_decap_add_del'@%p to host byte order", msg);
  vapi_type_msg_header2_t_ntoh(&msg->header);
  vapi_msg_udp_decap_add_del_payload_ntoh(&msg->payload);
}

static inline uword vapi_calc_udp_decap_add_del_msg_size(vapi_msg_udp_decap_add_del *msg)
{
  return sizeof(*msg);
}

static inline int vapi_verify_udp_decap_add_del_msg_size(vapi_msg_udp_decap_add_del *msg, uword buf_size)
{
  if (sizeof(vapi_msg_udp_decap_add_del) > buf_size)
    {
      VAPI_ERR("Truncated 'udp_decap_add_del' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_udp_decap_add_del));
      return -1;
    }
  if (vapi_calc_udp_decap_add_del_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'udp_decap_add_del' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_udp_decap_add_del_msg_size(msg));
      return -1;
    }
  return 0;
}

static inline vapi_msg_udp_decap_add_del* vapi_alloc_udp_decap_add_del(struct vapi_ctx_s *ctx)
{
  vapi_msg_udp_decap_add_del *msg = NULL;
  const size_t size = sizeof(vapi_msg_udp_decap_add_del);
  /* cast here required to play nicely with C++ world ... */
  msg = (vapi_msg_udp_decap_add_del*)vapi_msg_alloc(ctx, size);
  if (!msg) {
    return NULL;
  }
  msg->header.client_index = vapi_get_client_index(ctx);
  msg->header.context = 0;
  msg->header._vl_msg_id = vapi_lookup_vl_msg_id(ctx, vapi_msg_id_udp_decap_add_del);

  return msg;
}

static inline vapi_error_e vapi_udp_decap_add_del(struct vapi_ctx_s *ctx,
  vapi_msg_udp_decap_add_del *msg,
  vapi_error_e (*reply_callback)(struct vapi_ctx_s *ctx,
                                 void *callback_ctx,
                                 vapi_error_e rv,
                                 bool is_last,
                                 vapi_payload_udp_decap_add_del_reply *reply),
  void *reply_callback_ctx)
{
  if (!msg || !reply_callback) {
    return VAPI_EINVAL;
  ...
  if (VAPI_OK == (rv = vapi_send (ctx, msg))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_udp_decap_add_del_reply, VAPI_REQUEST_REG, 
                       (vapi_cb_t)reply_callback, reply_callback_ctx);
    if (VAPI_OK != vapi_producer_unlock (ctx)) {
      abort (); /* this really shouldn't happen */
    }
...
static void __attribute__((constructor)) __vapi_constructor_udp_decap_add_del()
{
  static const char name[] = "udp_decap_add_del";
  static const char name_with_crc[] = "udp_decap_add_del_d14a4f47";
  static vapi_message_desc_t __vapi_metadata_udp_decap_add_del = {
    name,
    sizeof(name) - 1,
    name_with_crc,
    sizeof(name_with_crc) - 1,
    true,
    offsetof(vapi_type_msg_header2_t, context),
    offsetof(vapi_msg_udp_decap_add_del, payload),
    (verify_msg_size_fn_t)vapi_verify_udp_decap_add_del_msg_size,
    (generic_swap_fn_t)vapi_msg_udp_decap_add_del_hton,
    (generic_swap_fn_t)vapi_msg_udp_decap_add_del_ntoh,
    VAPI_INVALID_MSG_ID,
  };

  vapi_msg_id_udp_decap_add_del = vapi_register_msg(&__vapi_metadata_udp_decap_add_del);
  VAPI_DBG("Assigned msg id %d to udp_decap_add_del", vapi_msg_id_udp_decap_add_del);
}
#endif
