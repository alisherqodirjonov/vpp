#ifndef __included_ioam_export_api_json
#define __included_ioam_export_api_json
...
static inline int vapi_verify_ioam_export_ip6_enable_disable_reply_msg_size(vapi_msg_ioam_export_ip6_enable_disable_reply *msg, uword buf_size)
{
  if (sizeof(vapi_msg_ioam_export_ip6_enable_disable_reply) > buf_size)
    {
      VAPI_ERR("Truncated 'ioam_export_ip6_enable_disable_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_ioam_export_ip6_enable_disable_reply));
      return -1;
    }
  if (vapi_calc_ioam_export_ip6_enable_disable_reply_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'ioam_export_ip6_enable_disable_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_ioam_export_ip6_enable_disable_reply_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_ioam_export_ip6_enable_disable_reply()
{
  ...
  static vapi_message_desc_t __vapi_metadata_ioam_export_ip6_enable_disable_reply = {
    ...
    (verify_msg_size_fn_t)vapi_verify_ioam_export_ip6_enable_disable_reply_msg_size,
...
static inline int vapi_verify_ioam_export_ip6_enable_disable_msg_size(vapi_msg_ioam_export_ip6_enable_disable *msg, uword buf_size)
{
  if (sizeof(vapi_msg_ioam_export_ip6_enable_disable) > buf_size)
    {
      VAPI_ERR("Truncated 'ioam_export_ip6_enable_disable' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_ioam_export_ip6_enable_disable));
      return -1;
    }
  if (vapi_calc_ioam_export_ip6_enable_disable_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'ioam_export_ip6_enable_disable' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_ioam_export_ip6_enable_disable_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send (ctx, msg))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_ioam_export_ip6_enable_disable_reply, VAPI_REQUEST_REG, 
...
static void __attribute__((constructor)) __vapi_constructor_ioam_export_ip6_enable_disable()
{
  ...
  static const char name_with_crc[] = "ioam_export_ip6_enable_disable_d4c76d3a";
  static vapi_message_desc_t __vapi_metadata_ioam_export_ip6_enable_disable = {
    ...
    (verify_msg_size_fn_t)vapi_verify_ioam_export_ip6_enable_disable_msg_size,
