#ifndef __included_dhcp6_pd_client_cp_api_json
#define __included_dhcp6_pd_client_cp_api_json
...
static inline int vapi_verify_dhcp6_pd_client_enable_disable_reply_msg_size(vapi_msg_dhcp6_pd_client_enable_disable_reply *msg, uword buf_size)
{
  if (sizeof(vapi_msg_dhcp6_pd_client_enable_disable_reply) > buf_size)
    {
      VAPI_ERR("Truncated 'dhcp6_pd_client_enable_disable_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_dhcp6_pd_client_enable_disable_reply));
      return -1;
    }
  if (vapi_calc_dhcp6_pd_client_enable_disable_reply_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'dhcp6_pd_client_enable_disable_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_dhcp6_pd_client_enable_disable_reply_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_dhcp6_pd_client_enable_disable_reply()
{
  ...
  static vapi_message_desc_t __vapi_metadata_dhcp6_pd_client_enable_disable_reply = {
    ...
    (verify_msg_size_fn_t)vapi_verify_dhcp6_pd_client_enable_disable_reply_msg_size,
...
static inline int vapi_verify_dhcp6_pd_client_enable_disable_msg_size(vapi_msg_dhcp6_pd_client_enable_disable *msg, uword buf_size)
{
  if (sizeof(vapi_msg_dhcp6_pd_client_enable_disable) > buf_size)
    {
      VAPI_ERR("Truncated 'dhcp6_pd_client_enable_disable' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_dhcp6_pd_client_enable_disable));
      return -1;
    }
  if (vapi_calc_dhcp6_pd_client_enable_disable_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'dhcp6_pd_client_enable_disable' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_dhcp6_pd_client_enable_disable_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send (ctx, msg))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_dhcp6_pd_client_enable_disable_reply, VAPI_REQUEST_REG, 
...
static void __attribute__((constructor)) __vapi_constructor_dhcp6_pd_client_enable_disable()
{
  ...
  static const char name_with_crc[] = "dhcp6_pd_client_enable_disable_a75a0772";
  static vapi_message_desc_t __vapi_metadata_dhcp6_pd_client_enable_disable = {
    ...
    (verify_msg_size_fn_t)vapi_verify_dhcp6_pd_client_enable_disable_msg_size,
...
static inline int vapi_verify_ip6_add_del_address_using_prefix_reply_msg_size(vapi_msg_ip6_add_del_address_using_prefix_reply *msg, uword buf_size)
{
  if (sizeof(vapi_msg_ip6_add_del_address_using_prefix_reply) > buf_size)
    {
      VAPI_ERR("Truncated 'ip6_add_del_address_using_prefix_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_ip6_add_del_address_using_prefix_reply));
      return -1;
    }
  if (vapi_calc_ip6_add_del_address_using_prefix_reply_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'ip6_add_del_address_using_prefix_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_ip6_add_del_address_using_prefix_reply_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_ip6_add_del_address_using_prefix_reply()
{
  ...
  static vapi_message_desc_t __vapi_metadata_ip6_add_del_address_using_prefix_reply = {
    ...
    (verify_msg_size_fn_t)vapi_verify_ip6_add_del_address_using_prefix_reply_msg_size,
...
typedef struct __attribute__ ((__packed__)) {
  vapi_type_interface_index sw_if_index;
  u8 prefix_group[64];
  vapi_type_ip6_address_with_prefix address_with_prefix;
  bool is_add; 
...
static inline int vapi_verify_ip6_add_del_address_using_prefix_msg_size(vapi_msg_ip6_add_del_address_using_prefix *msg, uword buf_size)
{
  if (sizeof(vapi_msg_ip6_add_del_address_using_prefix) > buf_size)
    {
      VAPI_ERR("Truncated 'ip6_add_del_address_using_prefix' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_ip6_add_del_address_using_prefix));
      return -1;
    }
  if (vapi_calc_ip6_add_del_address_using_prefix_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'ip6_add_del_address_using_prefix' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_ip6_add_del_address_using_prefix_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send (ctx, msg))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_ip6_add_del_address_using_prefix_reply, VAPI_REQUEST_REG, 
                       (vapi_cb_t)reply_callback, reply_callback_ctx);
    if (VAPI_OK != vapi_producer_unlock (ctx)) {
      abort (); /* this really shouldn't happen */
    }
...
static void __attribute__((constructor)) __vapi_constructor_ip6_add_del_address_using_prefix()
{
  ...
  static const char name_with_crc[] = "ip6_add_del_address_using_prefix_3982f30a";
  static vapi_message_desc_t __vapi_metadata_ip6_add_del_address_using_prefix = {
    ...
    (verify_msg_size_fn_t)vapi_verify_ip6_add_del_address_using_prefix_msg_size,
