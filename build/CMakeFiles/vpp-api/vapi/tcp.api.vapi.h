#ifndef __included_tcp_api_json
#define __included_tcp_api_json
...
static inline int vapi_verify_tcp_configure_src_addresses_reply_msg_size(vapi_msg_tcp_configure_src_addresses_reply *msg, uword buf_size)
{
  if (sizeof(vapi_msg_tcp_configure_src_addresses_reply) > buf_size)
    {
      VAPI_ERR("Truncated 'tcp_configure_src_addresses_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_tcp_configure_src_addresses_reply));
      return -1;
    }
  if (vapi_calc_tcp_configure_src_addresses_reply_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'tcp_configure_src_addresses_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_tcp_configure_src_addresses_reply_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_tcp_configure_src_addresses_reply()
{
  ...
  static vapi_message_desc_t __vapi_metadata_tcp_configure_src_addresses_reply = {
    ...
    (verify_msg_size_fn_t)vapi_verify_tcp_configure_src_addresses_reply_msg_size,
...
static inline int vapi_verify_tcp_configure_src_addresses_msg_size(vapi_msg_tcp_configure_src_addresses *msg, uword buf_size)
{
  if (sizeof(vapi_msg_tcp_configure_src_addresses) > buf_size)
    {
      VAPI_ERR("Truncated 'tcp_configure_src_addresses' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_tcp_configure_src_addresses));
      return -1;
    }
  if (vapi_calc_tcp_configure_src_addresses_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'tcp_configure_src_addresses' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_tcp_configure_src_addresses_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send (ctx, msg))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_tcp_configure_src_addresses_reply, VAPI_REQUEST_REG, 
...
static void __attribute__((constructor)) __vapi_constructor_tcp_configure_src_addresses()
{
  ...
  static const char name_with_crc[] = "tcp_configure_src_addresses_67eede0d";
  static vapi_message_desc_t __vapi_metadata_tcp_configure_src_addresses = {
    ...
    (verify_msg_size_fn_t)vapi_verify_tcp_configure_src_addresses_msg_size,
