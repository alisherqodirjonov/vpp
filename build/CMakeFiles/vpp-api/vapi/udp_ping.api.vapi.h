#ifndef __included_udp_ping_api_json
#define __included_udp_ping_api_json
...
static inline int vapi_verify_udp_ping_add_del_reply_msg_size(vapi_msg_udp_ping_add_del_reply *msg, uword buf_size)
{
  if (sizeof(vapi_msg_udp_ping_add_del_reply) > buf_size)
    {
      VAPI_ERR("Truncated 'udp_ping_add_del_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_udp_ping_add_del_reply));
      return -1;
    }
  if (vapi_calc_udp_ping_add_del_reply_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'udp_ping_add_del_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_udp_ping_add_del_reply_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_udp_ping_add_del_reply()
{
  ...
  static vapi_message_desc_t __vapi_metadata_udp_ping_add_del_reply = {
    ...
    (verify_msg_size_fn_t)vapi_verify_udp_ping_add_del_reply_msg_size,
...
static inline int vapi_verify_udp_ping_add_del_msg_size(vapi_msg_udp_ping_add_del *msg, uword buf_size)
{
  if (sizeof(vapi_msg_udp_ping_add_del) > buf_size)
    {
      VAPI_ERR("Truncated 'udp_ping_add_del' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_udp_ping_add_del));
      return -1;
    }
  if (vapi_calc_udp_ping_add_del_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'udp_ping_add_del' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_udp_ping_add_del_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send (ctx, msg))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_udp_ping_add_del_reply, VAPI_REQUEST_REG, 
...
static void __attribute__((constructor)) __vapi_constructor_udp_ping_add_del()
{
  ...
  static const char name_with_crc[] = "udp_ping_add_del_fa2628fc";
  static vapi_message_desc_t __vapi_metadata_udp_ping_add_del = {
    ...
    (verify_msg_size_fn_t)vapi_verify_udp_ping_add_del_msg_size,
...
static inline int vapi_verify_udp_ping_export_reply_msg_size(vapi_msg_udp_ping_export_reply *msg, uword buf_size)
{
  if (sizeof(vapi_msg_udp_ping_export_reply) > buf_size)
    {
      VAPI_ERR("Truncated 'udp_ping_export_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_udp_ping_export_reply));
      return -1;
    }
  if (vapi_calc_udp_ping_export_reply_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'udp_ping_export_reply' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_udp_ping_export_reply_msg_size(msg));
      return -1;
    }
  return 0;
}
...
static void __attribute__((constructor)) __vapi_constructor_udp_ping_export_reply()
{
  ...
  static vapi_message_desc_t __vapi_metadata_udp_ping_export_reply = {
    ...
    (verify_msg_size_fn_t)vapi_verify_udp_ping_export_reply_msg_size,
...
static inline int vapi_verify_udp_ping_export_msg_size(vapi_msg_udp_ping_export *msg, uword buf_size)
{
  if (sizeof(vapi_msg_udp_ping_export) > buf_size)
    {
      VAPI_ERR("Truncated 'udp_ping_export' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        sizeof(vapi_msg_udp_ping_export));
      return -1;
    }
  if (vapi_calc_udp_ping_export_msg_size(msg) > buf_size)
    {
      VAPI_ERR("Truncated 'udp_ping_export' msg received, received %lu"
        "bytes, expected %lu bytes.", buf_size,
        vapi_calc_udp_ping_export_msg_size(msg));
      return -1;
    }
  return 0;
}
  ...
  void *reply_callback_ctx)
{
  ...
  if (VAPI_OK == (rv = vapi_send (ctx, msg))) {
    vapi_store_request(ctx, req_context, vapi_msg_id_udp_ping_export_reply, VAPI_REQUEST_REG, 
                       (vapi_cb_t)reply_callback, reply_callback_ctx);
    if (VAPI_OK != vapi_producer_unlock (ctx)) {
      abort (); /* this really shouldn't happen */
    }
...
static void __attribute__((constructor)) __vapi_constructor_udp_ping_export()
{
  ...
  static vapi_message_desc_t __vapi_metadata_udp_ping_export = {
    ...
    (verify_msg_size_fn_t)vapi_verify_udp_ping_export_msg_size,
