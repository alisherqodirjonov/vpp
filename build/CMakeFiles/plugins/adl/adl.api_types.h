...
#define VL_API_ADL_API_VERSION_MAJOR 1
#define VL_API_ADL_API_VERSION_MINOR 0
#define VL_API_ADL_API_VERSION_PATCH 1
/* Imported API files */
...
#define VL_API_ADL_INTERFACE_ENABLE_DISABLE_IS_CONSTANT_SIZE (1)
...
#define VL_API_ADL_INTERFACE_ENABLE_DISABLE_REPLY_IS_CONSTANT_SIZE (1)
...
#define VL_API_ADL_ALLOWLIST_ENABLE_DISABLE_IS_CONSTANT_SIZE (1)
...
#define VL_API_ADL_ALLOWLIST_ENABLE_DISABLE_REPLY_IS_CONSTANT_SIZE (1)
