...
_(VL_API_IP6_ADD_DEL_ADDRESS_USING_PREFIX, ip6_add_del_address_using_prefix, 3982f30a) \
...
#include "dhcp6_pd_client_cp.api_tojson.h"
#include "dhcp6_pd_client_cp.api_fromjson.h"

static inline u8 *vl_api_dhcp6_pd_client_enable_disable_t_format (u8 *s,  va_list *args)
{
    __attribute__((unused)) vl_api_dhcp6_pd_client_enable_disable_t *a = va_arg (*args, vl_api_dhcp6_pd_client_enable_disable_t *);
...
static inline u8 *vl_api_dhcp6_pd_client_enable_disable_reply_t_format (u8 *s,  va_list *args)
{
    __attribute__((unused)) vl_api_dhcp6_pd_client_enable_disable_reply_t *a = va_arg (*args, vl_api_dhcp6_pd_client_enable_disable_reply_t *);
    u32 indent __attribute__((unused)) = 2;
    int i __attribute__((unused));
...
static inline u8 *vl_api_ip6_add_del_address_using_prefix_t_format (u8 *s,  va_list *args)
{
    __attribute__((unused)) vl_api_ip6_add_del_address_using_prefix_t *a = va_arg (*args, vl_api_ip6_add_del_address_using_prefix_t *);
    u32 indent __attribute__((unused)) = 2;
    int i __attribute__((unused));
...
static inline u8 *vl_api_ip6_add_del_address_using_prefix_reply_t_format (u8 *s,  va_list *args)
{
    __attribute__((unused)) vl_api_ip6_add_del_address_using_prefix_reply_t *a = va_arg (*args, vl_api_ip6_add_del_address_using_prefix_reply_t *);
    u32 indent __attribute__((unused)) = 2;
    int i __attribute__((unused));
...
static inline void vl_api_dhcp6_pd_client_enable_disable_t_endian (vl_api_dhcp6_pd_client_enable_disable_t *a, bool to_net)
{
    int i __attribute__((unused));
...
static inline void vl_api_dhcp6_pd_client_enable_disable_reply_t_endian (vl_api_dhcp6_pd_client_enable_disable_reply_t *a, bool to_net)
{
    int i __attribute__((unused));
    a->_vl_msg_id = clib_net_to_host_u16(a->_vl_msg_id);
    a->context = clib_net_to_host_u32(a->context);
...
static inline void vl_api_ip6_add_del_address_using_prefix_t_endian (vl_api_ip6_add_del_address_using_prefix_t *a, bool to_net)
{
    int i __attribute__((unused));
    a->_vl_msg_id = clib_net_to_host_u16(a->_vl_msg_id);
    /* a->client_index = a->client_index (no-op) */
    ...
    vl_api_interface_index_t_endian(&a->sw_if_index, to_net);
    /* a->prefix_group = a->prefix_group (no-op) */
    vl_api_ip6_address_with_prefix_t_endian(&a->address_with_prefix, to_net);
    /* a->is_add = a->is_add (no-op) */
}

static inline void vl_api_ip6_add_del_address_using_prefix_reply_t_endian (vl_api_ip6_add_del_address_using_prefix_reply_t *a, bool to_net)
{
    int i __attribute__((unused));
    a->_vl_msg_id = clib_net_to_host_u16(a->_vl_msg_id);
    a->context = clib_net_to_host_u32(a->context);
...
#ifndef included_dhcp6_pd_client_cp_calcsizefun
#define included_dhcp6_pd_client_cp_calcsizefun

/* calculate message size of message in network byte order */
static inline uword vl_api_dhcp6_pd_client_enable_disable_t_calc_size (vl_api_dhcp6_pd_client_enable_disable_t *a)
{
      return sizeof(*a) - sizeof(a->sw_if_index) + vl_api_interface_index_t_calc_size(&a->sw_if_index);
}

/* calculate message size of message in network byte order */
static inline uword vl_api_dhcp6_pd_client_enable_disable_reply_t_calc_size (vl_api_dhcp6_pd_client_enable_disable_reply_t *a)
{
      return sizeof(*a);
}

/* calculate message size of message in network byte order */
static inline uword vl_api_ip6_add_del_address_using_prefix_t_calc_size (vl_api_ip6_add_del_address_using_prefix_t *a)
{
      return sizeof(*a) - sizeof(a->sw_if_index) + vl_api_interface_index_t_calc_size(&a->sw_if_index) - sizeof(a->address_with_prefix) + vl_api_ip6_address_with_prefix_t_calc_size(&a->address_with_prefix);
}

/* calculate message size of message in network byte order */
static inline uword vl_api_ip6_add_del_address_using_prefix_reply_t_calc_size (vl_api_ip6_add_del_address_using_prefix_reply_t *a)
{
      return sizeof(*a);
}
