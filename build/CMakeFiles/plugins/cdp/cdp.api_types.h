...
#define VL_API_CDP_API_VERSION_MAJOR 1
#define VL_API_CDP_API_VERSION_MINOR 0
#define VL_API_CDP_API_VERSION_PATCH 0
/* Imported API files */
...
#define VL_API_CDP_ENABLE_DISABLE_IS_CONSTANT_SIZE (1)
...
#define VL_API_CDP_ENABLE_DISABLE_REPLY_IS_CONSTANT_SIZE (1)
